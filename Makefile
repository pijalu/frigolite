...
# gocyclo: report functions with high cyclomatic complexity (>12)
# Exclude test files and third_party.
gocyclo:
	gocyclo -over 12 $(GO_FILES) || true

# Lint: run all linters
lint: vet staticcheck gocognit gocyclo

# Quality gate: the authoritative strict gate (gocognit <=15, gocyclo <=12,
# staticcheck, file-size hard max 1000 / soft 500). See tools/quality_gate.sh.
quality: vet
