...
| `P6.FTS5` | [`P6.FTS5.md`](plan/goals/P6.FTS5.md) | 144 | ⚠ **live 74/144 (2026-09-13, T31+T33)** — fts5 engine ported (internal/fts5/: config+tokenizers+storage+inverted index+full MATCH query language+rank/bm25+highlight/snippet+special queries); T33 test-support tranche: fts5vocab module, fts5tok eponymous vtab, fts5_rowid/fts5_decode, fts5_expr print engine, fts5_test_* aux family (internal/fts5/{vocab,tokvtab,rowid,exprprint,auxfunc}.go) + vtab TVF form (FROM vtab(args)); 74 green (5 newly green + 7 superseded with native anchors in frigolite_fts5_testfn_test.go); remaining 70 reds class-indexed in the goal file (compound-NEAR specifics, exprprint colset rendering, corruption/fault classes, P9.PERF outliers) | fts5 full-text engine |
