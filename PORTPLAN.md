...
| `P6.RTREE` | [`P6.RTREE.md`](plan/goals/P6.RTREE.md) | 27 | ⚠ **live 26/27 (2026-09-12, T29)** — rtree,rtree1-9,A-K,check,circ,connect,doc,doc2,doc3 GREEN (rtreeJ/rtreeA/rtree8/rtreedoc* partial supersessions w/ native evidence: frigolite_rtreeA_J_8_native_test.go + frigolite_rtree_query2_test.go). REMAINING: rtreefuzz001 — geopoly module (goal-scoped, feature-complete port = next tranche) + %_node partial-read leniency (btree-owned). Landed: sqlite3_index_info-era xBestIndex/xFilter rtree contract (RtreeQueryInfo, priority-queue search, NO_VTAB shadow scope), aux-column C parity, node codec hardening, backup/VACUUM vtab handling, CREATE-VTAB master-order parity, REPLACE conflict-key perf | R-tree virtual table module (rtree, rtree_i32, geopoly) |
