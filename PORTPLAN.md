...
| `P6.FTS5` | [`P6.FTS5.md`](plan/goals/P6.FTS5.md) | 144 | ⚠ **live 57/144 (2026-09-13, T31)** — fts5 engine ported (internal/fts5/: config+tokenizers+storage+inverted index+full MATCH query language+rank/bm25+highlight/snippet+special queries); 57 testgen packages green (from 0 converted at queue time); remaining 87 reds class-indexed in the goal file (compound-NEAR specifics, fts5_tcl.c harness APIs N-A, vocab/aux modules, P9.PERF outliers) | fts5 full-text engine |
