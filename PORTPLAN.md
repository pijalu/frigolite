...
| `P8.PAGER` | [`P8.PAGER.md`](plan/goals/P8.PAGER.md) | 24 | ⚠ **ACTIVE** (2026-09-06, batches 1-8) — 18/24 pass (cache/memdb/memdb1/memdb2/filefmt/pagesize/pendingrace green since batches 3-8; run-verified 2026-09-06 serial). Remaining 6 red: sqllimits1 (6 mismatches), memsubsys1/2, bitvec (hang), oserror, sqldiff1 — T3.5 order in sub-plan. | Pager/page-format/btree validation (SQL surface) |
