...
var unsupportedTestFiles = map[string]string{
	...
	"json101": "JSON functions not implemented",
	"json102": "JSON functions not implemented",
	"json103": "JSON functions not implemented",
	"json104": "JSON functions not implemented",
	"json105": "JSON functions not implemented",
	"json108": "JSON functions not implemented",
	"json109": "JSON functions not implemented",
	"json501": "JSON functions not implemented",
	"jsonb01": "JSON functions not implemented",
	...
	"stmtvtab1": "Virtual table module not implemented in frigolite",
	"swarmvtab": "Virtual table module not implemented in frigolite",
	"swarmvtab2": "Virtual table module not implemented in frigolite",
	...
	"vtabrhs1": "Virtual table module not implemented in frigolite",
