...
// setEmptyLeafContent initializes an empty leaf page's cell-content pointer
// to the usable page end, matching SQLite's empty-page layout (the page
// validator rejects a zero content pointer on a full-size page).
func setEmptyLeafContent(rootPg *pager.Page) {
