...
func TestInvertedIndexInsertAndSearch(t *testing.T) {
	...
	id1 := idx.Insert([]interface{}{"hello world"}, tok)
	if id1 != 1 {
		t.Errorf("first insert docid = %d, want 1", id1)
	}

	id2 := idx.Insert([]interface{}{"goodbye world"}, tok)
	if id2 != 2 {
...
func TestInvertedIndexDelete(t *testing.T) {
	...
	idx.Insert([]interface{}{"hello world"}, tok)
	idx.Insert([]interface{}{"goodbye world"}, tok)
...
func TestInvertedIndexUpdate(t *testing.T) {
	...
	// Update doc 1
	idx.Update(1, []interface{}{"foo bar"}, tok)
...
func TestInvertedIndexPhrase(t *testing.T) {
	...
	idx.Insert([]interface{}{"hello world foo"}, tok)
	idx.Insert([]interface{}{"hello foo world"}, tok)
...
func TestInvertedIndexPrefix(t *testing.T) {
	...
	idx.Insert([]interface{}{"hello world"}, tok)
	idx.Insert([]interface{}{"help me"}, tok)
	idx.Insert([]interface{}{"goodbye"}, tok)
...
func TestInvertedIndexInsertWithID(t *testing.T) {
	...
	idx.InsertWithID(100, []interface{}{"hello"}, tok)
	idx.InsertWithID(200, []interface{}{"world"}, tok)
...
func TestQueryMatching(t *testing.T) {
	...
	idx.Insert([]interface{}{"hello world foo"}, tok)
	idx.Insert([]interface{}{"goodbye world"}, tok)
	idx.Insert([]interface{}{"hello there"}, tok)
...
func TestPrefixMatching(t *testing.T) {
	...
	idx.Insert([]interface{}{"hello"}, tok)
	idx.Insert([]interface{}{"help"}, tok)
	idx.Insert([]interface{}{"world"}, tok)
