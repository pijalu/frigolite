...
func Test_aggnested(t *testing.T) {
	...
	vtab.TclVarSet("testprefix", "", "aggnested")
	...
	{ // "aggnested-1.2" — skipped: mixed outer+inner aggregates in one correlated subquery expression N-A (SQL + file side effects only)
	...
	{ // "aggnested-10.1" — skipped: nested aggregate inside compound SELECT validation not implemented N-A
	}
	{ // "11.1"
	...
	{ // "aggnested-11.3" — skipped: nested aggregate inside compound SELECT validation not implemented N-A
	}
}
