...
func Test_analyze6(t *testing.T) {
	...
	{ // do_test "analyze6-1.1"
		t.Skipf("TODO: %s not implemented in frigolite", "eqp {SELECT count(*) FROM ev, cat WHERE x=y}")
	}
	{ // "analyze6-1.2"
	...
	{ // do_test "analyze6-2.1"
		...
		t.Skipf("TODO: %s not implemented in frigolite", "eqp {SELECT * FROM t201 WHERE z=5}")
	}
	{ // do_test "analyze6-2.2"
		t.Skipf("TODO: %s not implemented in frigolite", "eqp {SELECT * FROM t201 WHERE y=5}")
	}
	{ // do_test "analyze6-2.3"
		t.Skipf("TODO: %s not implemented in frigolite", "eqp {SELECT * FROM t201 WHERE x=5}")
	}
