...
func Test_bigmmap(t *testing.T) {
	...
	vtab.TclVarSet("testprefix", "", "bigmmap")
	testprefix = "bigmmap"
	_ = testprefix // suppress unused warning
	vtab.TclVarSet("mmap_limit", "", "0")
	mmap_limit = "0"
	...
	for func() bool { i_n, _i_e := strconv.Atoi(i); if _i_e != nil { return false }; return i_n < 8 }() {
		...
		tclHexioWrite("test.db", int64(28), tclFormat("%.8x", tclExprWith("($i*1024*1024*1024/4096) - 5", map[string]string{"i": i})))
		{ // "1." + i
