...
func Test_bigrow(t *testing.T) {
	...
	{ // do_test "bigrow-1.0"
		...
		for func() bool { i_n, _i_e := strconv.Atoi(i); if _i_e != nil { return false }; return i_n <= 9999 }() {
			sep = tclStringIndex("abcdefghijklmnopqrstuvwxyz", tclExprWith("$i%26", map[string]string{"i": i}))
	...
	{ // do_test "bigrow-1.2"
		vtab.TclVarSet("big1", "", tclStringRange(bigstr, "0", "65519"))
		big1 = tclStringRange(bigstr, "0", "65519") // TCL namespace variable
		_ = big1 // suppress unused warning
		vtab.TclVarSet("sql", "", "INSERT INTO t1 VALUES('abc',")
	...
	{ // do_test "bigrow-1.4"
		vtab.TclVarSet("big2", "", tclStringRange(bigstr, "0", "65520"))
		big2 = tclStringRange(bigstr, "0", "65520") // TCL namespace variable
		_ = big2 // suppress unused warning
		vtab.TclVarSet("sql", "", "INSERT INTO t1 VALUES('abc2',")
