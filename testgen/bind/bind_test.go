...
func Test_bind(t *testing.T) {
	...
	{ // do_test "bind-9.5"
		...
		_r = tclBindStmt(db, "VM", tclToInt(tclExprWith("$iMaxVar - 2", map[string]string{"iMaxVar": iMaxVar})), "int", "999", -1)
		_r = tclBindStmt(db, "VM", tclToInt(tclExprWith("$iMaxVar - 1", map[string]string{"iMaxVar": iMaxVar})), "int", "1000", -1)
		_r = tclBindStmt(db, "VM", tclToInt(iMaxVar), "int", "1001", -1)
		_r = tclStepStmt(db, "VM")
	}
	{ // do_test "bind-9.6"
		_r = tclFinalizeStmt(db, "VM")
