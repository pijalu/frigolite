...
func Test_carray01(t *testing.T) {
	...
	vtab.TclVarSet("testprefix", "", "carray01")
	testprefix = "carray01"
	_ = testprefix // suppress unused warning
	// proc definition (not transpiled)
	{ // "100" (prepare-step internals; SQL side effects only)
		// prepared STMT: SELECT 5 IN carray(?3) (bind/step emulation)
		tclPrepareStep(db, "SELECT 5 IN carray(?3)", "STMT")
	...
	{ // "103" (prepare-step internals; SQL side effects only)
		// prepared STMT2: SELECT DISTINCT typeof(value) FROM carray(?3) (bind/step emulation)
		tclPrepareStep(db, "SELECT DISTINCT typeof(value) FROM carray(?3)", "STMT2")
