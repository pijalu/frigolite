...
func Test_closure01(t *testing.T) {
	...
	vtab.TclVarSet("testprefix", "", "closure01")
	...
	// load_static_extension db closure (unsupported command, not transpiled)
	{ // "closure01-7.1" — skipped: malformed argv literal 'abc'x resolution N-A (vtab arg tokenization) (SQL side effects only)
		_res = db.Exec("\n  CREATE TABLE t(p, abcx);\n  INSERT INTO t VALUES(1, 2);\n")
		_ = _res.Error // tolerate unsupported-feature errors in skipped tests
	}
	{ // "closure01-7.2" — skipped: malformed argv literal 'abc'x resolution N-A (vtab arg tokenization) (SQL side effects only)
		_res = db.Exec("\n  CREATE VIRTUAL TABLE c\n    USING transitive_closure(idcolumn='abc'x, tablename='t', parentcolumn='p');\n")
		_ = _res.Error // tolerate unsupported-feature errors in skipped tests
	}
	{ // "closure01-7.3" — skipped: malformed argv literal 'abc'x resolution N-A (vtab arg tokenization) (SQL side effects only)
