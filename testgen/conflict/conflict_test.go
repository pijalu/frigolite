...
func Test_conflict(t *testing.T) {
	...
	_items0 := tclSplitList("1 INSERT                  1 {}  1  0\n  2 {INSERT OR IGNORE}      0 3   1  0\n  3 {INSERT OR REPLACE}     0 4   1  0\n  4 REPLACE                 0 4   1  0\n  5 {INSERT OR FAIL}        1 {}  1  0\n  6 {INSERT OR ABORT}       1 {}  1  0\n  7 {INSERT OR ROLLBACK}    1 {}  {} 0")
	for _idx0 := 0; _idx0+6 <= len(_items0); _idx0 += 6 {
		...
		_ = _idx0
			{ // do_test "conflict-1." + i
				vtab.TclVarSet("sqlite_opentemp_count", "", "0")
	...
	_ = r1 // suppress unused warning
				...
				if tclBool(r0) {
					...
					r1 = tclExecSQL(db, "SELECT c FROM t1")
					_ = r1 // suppress unused warning
				}
	...
	_ = r1 // suppress unused warning
						...
						for _idx5 := 0; _idx5+8 <= len(_items5); _idx5 += 8 {
							...
							_ = _idx5
								...
								if tclBool(tclBool01(vtab.TclVarExists("TEMP_STORE", "")) + " && " + TEMP_STORE + "==3") {
									vtab.TclVarSet("t3", "", "0")
									t3 = "0"
									_ = t3 // suppress unused warning
								} else {
	...
	_ = r1 // suppress unused warning
							...
							{ // do_test "conflict-7.1"
								...
								for func() bool { i_n, _i_e := strconv.Atoi(i); if _i_e != nil { return false }; return i_n <= 50 }() {
									_res = db.Exec("INSERT into t1 values(" + i + "," + tclExprWith("$i+1", map[string]string{"i": i}) + ");")
									if _res.Error != nil {
										t.Errorf("exec error: %v\n  sql: %s", _res.Error, "INSERT into t1 values(" + i + "," + tclExprWith("$i+1", map[string]string{"i": i}) + ");")
									}
									// incr i 1
									{
							...
							// verify_ex_errcode conflict-13.1b SQLITE_CONSTRAINT_CHECK (unsupported command, not transpiled)
