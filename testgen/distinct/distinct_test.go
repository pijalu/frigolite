...
func Test_distinct(t *testing.T) {
	...
	sql := _items[_idx+2]
		if tclBool(noop) {
			...
			t.Skipf("TODO: %s not implemented in frigolite", "do_distinct_not_noop_test 1.$tn $sql")
		}
	}
	}
	...
	res := _items[_idx+3]
		...
		t.Skipf("TODO: %s not implemented in frigolite", "do_temptables_test 2.$tn.2 SELECT DISTINCT $sql $temptables")
	}
	}
	{ // "2.A"
