...
func Test_distinct2(t *testing.T) {
	...
	vtab.TclVarSet("testprefix", "", "distinct2")
	...
	{ // "distinct2-120" — skipped: forward-reference join ON column not resolved (G3.INDEX) (SQL side effects only)
	...
	{ // "distinct2-6020" — skipped: FULL OUTER JOIN not implemented (SQL side effects only)
	...
	{ // "distinct2-6050" — skipped: FULL OUTER JOIN not implemented (SQL side effects only)
		_res = db.Exec("\n  SELECT DISTINCT * FROM t1 FULL OUTER JOIN t0 ON c0>c1;\n")
		_ = _res.Error // tolerate unsupported-feature errors in skipped tests
	}
}
