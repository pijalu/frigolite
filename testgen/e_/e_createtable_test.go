...
func Test_e_createtable(t *testing.T) {
	...
	// foreach {tn tbl select} "1   x1   \"SELECT * FROM t1\"\n  2   x2   \"SELECT * FROM t1 ORDER BY x DESC\"\n  3   x3   \"SELECT * FROM t1 ORDER BY x ASC\""
	_items0 := tclSplitList("1   x1   \"SELECT * FROM t1\"\n  2   x2   \"SELECT * FROM t1 ORDER BY x DESC\"\n  3   x3   \"SELECT * FROM t1 ORDER BY x ASC\"")
