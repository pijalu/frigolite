			...
			for _idx2 := 0; _idx2+2 <= len(_items2); _idx2 += 2 {
				...
				for _idx3 := 0; _idx3+2 <= len(_items3); _idx3 += 2 {
					...
					_ = _idx3
						...
						delete = "concat       [eqp \"DELETE FROM parent WHERE 1\"]       [eqp \"SELECT rowid FROM child WHERE a = ? AND b = ?\"]"
						_ = delete // suppress unused warning
						update = "concat       [eqp \"UPDATE parent SET x=?, y=?\"]       [eqp \"SELECT rowid FROM child WHERE a = ? AND b = ?\"]       [eqp \"SELECT rowid FROM child WHERE a = ? AND b = ?\"]"
						...
						{ // do_test "e_fkey-26." + tn + ".1"
							...
							if _res.Error == nil || !strings.Contains(_res.Error.Error(), delete) {
								t.Errorf("expected error containing %s, got: %v\n  body: do_test %s", delete, _res.Error, "e_fkey-26." + tn + ".1")
							}
						}
						{ // do_test "e_fkey-26." + tn + ".2"
							// eqp UPDATE parent set x=?, y=? (unsupported command, not transpiled)
							if _res.Error == nil || !strings.Contains(_res.Error.Error(), update) {
								t.Errorf("expected error containing %s, got: %v\n  body: do_test %s", update, _res.Error, "e_fkey-26." + tn + ".2")
							}
						}
					...
					for _idx4 := 0; _idx4+3 <= len(_items4); _idx4 += 3 {
						...
						_ = _idx4
							...
							{ // do_test "e_fkey-28." + tn
								_res = db.Exec("catchsql " + sql)
								if _res.Error != nil {
									t.Errorf("exec error: %v\n  sql: %s", _res.Error, "catchsql " + sql)
								}
							}
						}
						{ // do_test "e_fkey-28.8"
							...
							for _idx6 := 0; _idx6+3 <= len(_items6); _idx6 += 3 {
								...
								_ = _idx6
									{ // do_test "e_fkey-54." + tn + ".off"
										...
										_ = _res // catchsql
										if _res.Error == nil || !strings.Contains(_res.Error.Error(), lRes) {
											t.Errorf("expected error containing %s, got: %v\n  body: do_test %s", lRes, _res.Error, "e_fkey-54." + tn + ".off")
										}
									}
									{ // do_test "e_fkey-54." + tn + ".on"
										...
										_ = _res // catchsql
										if _res.Error == nil || !strings.Contains(_res.Error.Error(), lRes) {
											t.Errorf("expected error containing %s, got: %v\n  body: do_test %s", lRes, _res.Error, "e_fkey-54." + tn + ".on")
										}
									}
								}
								// proc definition (not transpiled)
