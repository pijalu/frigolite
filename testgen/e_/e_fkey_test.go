...
func Test_e_fkey(t *testing.T) {
  ...
  {SCAN track}
				...
				{ // do_test "e_fkey-25.5"
					_r_tcl := append([]string{}, tclSplitList("execsql { SELECT rowid FROM track WHERE trackartist = 5 }")...)
				...
				{ // do_test "e_fkey-25.6"
					_r_tcl := append([]string{}, tclSplitList("execsql { SELECT rowid FROM track WHERE trackartist = 7 }")...)
				...
				{ // do_test "e_fkey-25.7"
					_r_tcl := append([]string{}, tclSplitList("execsql { SELECT rowid FROM track WHERE trackartist = 6 }")...)
