...
func Test_enc2(t *testing.T) {
	...
	db.Close()
	vtab.TclVarSet("values", "", "one"+" "+"two"+" "+"three"+" "+"four"+" "+"five")
	values = "one"+" "+"two"+" "+"three"+" "+"four"+" "+"five" // TCL namespace variable
	_ = values // suppress unused warning
	vtab.TclVarSet("test_collate_enc", "", "INVALID")
