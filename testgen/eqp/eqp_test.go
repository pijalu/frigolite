...
func Test_eqp(t *testing.T) {
  ...
  QUERY PLAN
  |--SCAN t1
  |--USE TEMP B-TREE FO...} (unsupported command, not transpiled)
	// det 2.2.2 SELECT DISTINCT min(x), max(x) FROM t2 GROUP BY x ... {
  QUERY PLAN
  |--SCAN t2 USING COVERING INDEX t2...} (unsupported command, not transpiled)
  ...
  QUERY PLAN
  `--SEARCH t2 USING COVERING INDEX ...} (unsupported command, not transpiled)
  ...
  QUERY PLAN
  `--SEARCH t1 USING INTEGER PRIMARY...} (unsupported command, not transpiled)
	{ // "3.1.1"
 ...
 ...} (unsupported command, not transpiled)
  ...
  QUERY PLAN
  |--SCAN t1
  `--LIST SUBQUERY xxxx...} (unsupported command, not transpiled)
	// det 3.3.2 {
  SELECT * FROM t1 WHERE y IN (SELECT y FROM t2 W...} {
  QUERY PLAN
  |--SCAN t1
  `--CORRELATED LIST SU...} (unsupported command, not transpiled)
	// det 3.3.3 {
  ...
  0 0 0 {SEARCH t1 USING COVERING INDEX i2 (a=?)}...} (unsupported command, not transpiled)
		{ // "5.4.0"
  ...
  0 0 0 {SEARCH t1 USING COVERING INDEX i2 (a=? A...} (unsupported command, not transpiled)
		// det 5.5 SELECT t1.a, t2.c FROM t2, t1 WHERE t1.a=1 AND t1.... {
  0 0 1 {SEARCH t1 USING COVERING INDEX i2 (a=? A...} (unsupported command, not transpiled)
		{ // "5.5.0"
  ...
  0 0 0 {SCAN t2}
  0 0 0 {USE TEMP B-TREE FOR OR...} (unsupported command, not transpiled)
		{ // "5.8.0"
  ...
  0 0 0...} (unsupported command, not transpiled)
		// det 5.10 {
  ...
  0 1 1 ...} (unsupported command, not transpiled)
		// det 5.12 SELECT a,b FROM t1 UNION SELECT c, 99 FROM t2 {
  1 0 0 {SCAN t1 USING COVERING INDEX i2}
  2 0 0...} (unsupported command, not transpiled)
...
1 0 0 SCAN t1 USING COVERING IN... (unsupported command, not transpiled)
		}
	}
	// drop_all_tables (unsupported command, not transpiled)
	{ // "7.0"
  ...
  QUERY PLAN
  `--SCAN t2 USING COVERING INDEX i1...} (unsupported command, not transpiled)
	{ // "7.3"
  ...
  QUERY PLAN
  `--SEARCH t2 USING INTEGER PRIMARY...} (unsupported command, not transpiled)
  ...
  QUERY PLAN
  `--SEARCH t1 USING PRIMARY KEY (b=...} (unsupported command, not transpiled)
