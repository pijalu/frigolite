...
func Test_fkey2(t *testing.T) {
		...
		_ = _idx0
			{ // do_test "fkey2-1.1." + tn + ".1"
				...
				if !tclCatchsqlMatches(_res, res) {
					t.Errorf("catchsql mismatch\n  got:  [%v]\n  want: [%s]\n  body: do_test %s", _res.Error, res, "fkey2-1.1." + tn + ".1")
				}
			}
		...
		for _idx1 := 0; _idx1+3 <= len(_items1); _idx1 += 3 {
			...
			_ = _idx1
				{ // do_test "fkey2-1.2." + tn
					...
					_ = _res // catchsql
					if !tclCatchsqlMatches(_res, res) {
						t.Errorf("catchsql mismatch\n  got:  [%v]\n  want: [%s]\n  body: do_test %s", _res.Error, res, "fkey2-1.2." + tn)
					}
				}
			...
			for _idx2 := 0; _idx2+3 <= len(_items2); _idx2 += 3 {
				...
				_ = _idx2
					...
					{ // do_test "fkey2-1.3." + tn
						...
						_ = _res // catchsql
						if !tclCatchsqlMatches(_res, res) {
							t.Errorf("catchsql mismatch\n  got:  [%v]\n  want: [%s]\n  body: do_test %s", _res.Error, res, "fkey2-1.3." + tn)
						}
					}
				...
				for _idx3 := 0; _idx3+3 <= len(_items3); _idx3 += 3 {
					...
					_ = _idx3
						...
						{ // do_test "fkey2-1.4." + tn
							...
							_ = _res // catchsql
							if !tclCatchsqlMatches(_res, res) {
								t.Errorf("catchsql mismatch\n  got:  [%v]\n  want: [%s]\n  body: do_test %s", _res.Error, res, "fkey2-1.4." + tn)
							}
						}
						_res = db.Exec("COMMIT")
						if _res.Error != nil {
					...
					// fkey2-2-test 4 0 UPDATE node SET parent = NULL (unsupported command, not transpiled)
					// fkey2-2-test 5 0 COMMIT (unsupported command, not transpiled)
					// fkey2-2-test 6 0 SELECT * FROM node {1 {}} (unsupported command, not transpiled)
					// fkey2-2-test 7 0 BEGIN (unsupported command, not transpiled)
					// fkey2-2-test 8 1 INSERT INTO leaf VALUES('a', 2) (unsupported command, not transpiled)
					// fkey2-2-test 9 1 INSERT INTO node VALUES(2, 0) (unsupported command, not transpiled)
					// fkey2-2-test 10 0 UPDATE node SET parent = 1 WHERE nodeid = 2 (unsupported command, not transpiled)
					// fkey2-2-test 11 0 COMMIT (unsupported command, not transpiled)
					// fkey2-2-test 12 0 SELECT * FROM node {1 {} 2 1} (unsupported command, not transpiled)
					// fkey2-2-test 13 0 SELECT * FROM leaf {a 2} (unsupported command, not transpiled)
					// fkey2-2-test 14 0 BEGIN (unsupported command, not transpiled)
					// fkey2-2-test 15 1 DELETE FROM node WHERE nodeid = 2 (unsupported command, not transpiled)
					// fkey2-2-test 16 0 INSERT INTO node VALUES(2, NULL) (unsupported command, not transpiled)
					// fkey2-2-test 17 0 COMMIT (unsupported command, not transpiled)
					// fkey2-2-test 18 0 SELECT * FROM node {1 {} 2 {}} (unsupported command, not transpiled)
					// fkey2-2-test 19 0 SELECT * FROM leaf {a 2} (unsupported command, not transpiled)
					// fkey2-2-test 20 0 BEGIN (unsupported command, not transpiled)
					// fkey2-2-test 21 0 INSERT INTO leaf VALUES('b', 1) (unsupported command, not transpiled)
					// fkey2-2-test 22 0 SAVEPOINT save (unsupported command, not transpiled)
					// fkey2-2-test 23 0 DELETE FROM node WHERE nodeid = 1 (unsupported command, not transpiled)
					// fkey2-2-test 24 0 ROLLBACK TO save (unsupported command, not transpiled)
					// fkey2-2-test 25 0 COMMIT (unsupported command, not transpiled)
					// fkey2-2-test 26 0 SELECT * FROM node {1 {} 2 {}} (unsupported command, not transpiled)
					// fkey2-2-test 27 0 SELECT * FROM leaf {a 2 b 1} (unsupported command, not transpiled)
					// fkey2-2-test 28 0 BEGIN (unsupported command, not transpiled)
					// fkey2-2-test 29 0 INSERT INTO leaf VALUES('c', 1) (unsupported command, not transpiled)
					// fkey2-2-test 30 0 SAVEPOINT save (unsupported command, not transpiled)
					// fkey2-2-test 31 0 DELETE FROM node WHERE nodeid = 1 (unsupported command, not transpiled)
					// fkey2-2-test 32 1 RELEASE save (unsupported command, not transpiled)
					// fkey2-2-test 33 1 DELETE FROM leaf WHERE cellid = 'b' (unsupported command, not transpiled)
					// fkey2-2-test 34 0 DELETE FROM leaf WHERE cellid = 'c' (unsupported command, not transpiled)
					// fkey2-2-test 35 0 COMMIT (unsupported command, not transpiled)
					// fkey2-2-test 36 0 SELECT * FROM node {2 {}} (unsupported command, not transpiled)
					// fkey2-2-test 37 0 SELECT * FROM leaf {a 2} (unsupported command, not transpiled)
					// fkey2-2-test 38 0 SAVEPOINT outer (unsupported command, not transpiled)
					// fkey2-2-test 39 1 INSERT INTO leaf VALUES('d', 3) (unsupported command, not transpiled)
					// fkey2-2-test 40 1 RELEASE outer FKV (unsupported command, not transpiled)
					// fkey2-2-test 41 1 INSERT INTO leaf VALUES('e', 3) (unsupported command, not transpiled)
					// fkey2-2-test 42 0 INSERT INTO node VALUES(3, 2) (unsupported command, not transpiled)
					// fkey2-2-test 43 0 RELEASE outer (unsupported command, not transpiled)
					// fkey2-2-test 44 0 SAVEPOINT outer (unsupported command, not transpiled)
					// fkey2-2-test 45 1 DELETE FROM node WHERE nodeid=3 (unsupported command, not transpiled)
					// fkey2-2-test 47 0 INSERT INTO node VALUES(3, 2) (unsupported command, not transpiled)
					// fkey2-2-test 48 0 ROLLBACK TO outer (unsupported command, not transpiled)
					// fkey2-2-test 49 0 RELEASE outer (unsupported command, not transpiled)
					// fkey2-2-test 50 0 SAVEPOINT outer (unsupported command, not transpiled)
					// fkey2-2-test 51 1 INSERT INTO leaf VALUES('f', 4) (unsupported command, not transpiled)
					// fkey2-2-test 52 1 SAVEPOINT inner (unsupported command, not transpiled)
					// fkey2-2-test 53 1 INSERT INTO leaf VALUES('g', 4) (unsupported command, not transpiled)
					// fkey2-2-test 54 1 RELEASE outer FKV (unsupported command, not transpiled)
					// fkey2-2-test 55 1 ROLLBACK TO inner (unsupported command, not transpiled)
					// fkey2-2-test 56 0 COMMIT FKV (unsupported command, not transpiled)
					// fkey2-2-test 57 0 INSERT INTO node VALUES(4, NULL) (unsupported command, not transpiled)
					// fkey2-2-test 58 0 RELEASE outer (unsupported command, not transpiled)
					// fkey2-2-test 59 0 SELECT * FROM node {2 {} 3 2 4 {}} (unsupported command, not transpiled)
					// fkey2-2-test 60 0 SELECT * FROM leaf {a 2 d 3 e 3 f 4} (unsupported command, not transpiled)
					// fkey2-2-test 61 0 BEGIN (unsupported command, not transpiled)
					// fkey2-2-test 62 0 DELETE FROM leaf (unsupported command, not transpiled)
					// fkey2-2-test 63 0 DELETE FROM node (unsupported command, not transpiled)
					...
					// fkey2-2-test 70 0 INSERT INTO node VALUES(2, NULL) (unsupported command, not transpiled)
					// fkey2-2-test 71 0 COMMIT (unsupported command, not transpiled)
					// fkey2-2-test 72 0 BEGIN (unsupported command, not transpiled)
	...
	_ = msg // suppress unused warning
					...
					// fkey2-8-test 3 { BEGIN                       } 1 (unsupported command, not transpiled)
					// fkey2-8-test 4 { PRAGMA foreign_keys = 0     } 1 (unsupported command, not transpiled)
					// fkey2-8-test 5 { COMMIT                      } 1 (unsupported command, not transpiled)
					// fkey2-8-test 6 { PRAGMA foreign_keys = 0     } 0 (unsupported command, not transpiled)
					// fkey2-8-test 7 { BEGIN                       } 0 (unsupported command, not transpiled)
					// fkey2-8-test 8 { PRAGMA foreign_keys = 1     } 0 (unsupported command, not transpiled)
					// fkey2-8-test 9 { COMMIT                      } 0 (unsupported command, not transpiled)
					// fkey2-8-test 10 { PRAGMA foreign_keys = 1     } 1 (unsupported command, not transpiled)
					// fkey2-8-test 11 { PRAGMA foreign_keys = off   } 0 (unsupported command, not transpiled)
					// fkey2-8-test 12 { PRAGMA foreign_keys = on    } 1 (unsupported command, not transpiled)
					// fkey2-8-test 13 { PRAGMA foreign_keys = no    } 0 (unsupported command, not transpiled)
