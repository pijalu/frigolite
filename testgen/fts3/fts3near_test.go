...
func Test_fts3near(t *testing.T) {
	...
	{ // do_test "fts3near-1.1"
		r = db.Query("SELECT docid FROM t1 WHERE content MATCH 'one NEAR/0 three'")
		if r.Error != nil {
			t.Errorf("query error: %v\n  sql: %s", r.Error, "SELECT docid FROM t1 WHERE content MATCH 'one NEAR/0 three'")
		}
	}
	{ // do_test "fts3near-1.2"
		r = db.Query("SELECT docid FROM t1 WHERE content MATCH 'one NEAR/1 two'")
		if r.Error != nil {
			t.Errorf("query error: %v\n  sql: %s", r.Error, "SELECT docid FROM t1 WHERE content MATCH 'one NEAR/1 two'")
		}
	}
	{ // do_test "fts3near-1.3"
		r = db.Query("SELECT docid FROM t1 WHERE content MATCH 'one NEAR/1 three'")
		if r.Error != nil {
			t.Errorf("query error: %v\n  sql: %s", r.Error, "SELECT docid FROM t1 WHERE content MATCH 'one NEAR/1 three'")
		}
	}
	{ // do_test "fts3near-1.4"
		r = db.Query("SELECT docid FROM t1 WHERE content MATCH 'three NEAR/1 one'")
		if r.Error != nil {
			t.Errorf("query error: %v\n  sql: %s", r.Error, "SELECT docid FROM t1 WHERE content MATCH 'three NEAR/1 one'")
		}
	}
	{ // do_test "fts3near-1.5"
		r = db.Query("SELECT docid FROM t1 WHERE content MATCH '\"one two\" NEAR/1 five'")
		if r.Error != nil {
			t.Errorf("query error: %v\n  sql: %s", r.Error, "SELECT docid FROM t1 WHERE content MATCH '\"one two\" NEAR/1 five'")
		}
	}
	{ // do_test "fts3near-1.6"
		r = db.Query("SELECT docid FROM t1 WHERE content MATCH '\"one two\" NEAR/2 five'")
		if r.Error != nil {
			t.Errorf("query error: %v\n  sql: %s", r.Error, "SELECT docid FROM t1 WHERE content MATCH '\"one two\" NEAR/2 five'")
		}
	}
	{ // do_test "fts3near-1.7"
		r = db.Query("SELECT docid FROM t1 WHERE content MATCH 'one NEAR four'")
		if r.Error != nil {
			t.Errorf("query error: %v\n  sql: %s", r.Error, "SELECT docid FROM t1 WHERE content MATCH 'one NEAR four'")
		}
	}
	{ // do_test "fts3near-1.8"
		r = db.Query("SELECT docid FROM t1 WHERE content MATCH 'four NEAR three'")
		if r.Error != nil {
			t.Errorf("query error: %v\n  sql: %s", r.Error, "SELECT docid FROM t1 WHERE content MATCH 'four NEAR three'")
		}
	}
	{ // do_test "fts3near-1.9"
		r = db.Query("SELECT docid FROM t1 WHERE content MATCH '\"four five\" NEAR/0 three'")
		if r.Error != nil {
			t.Errorf("query error: %v\n  sql: %s", r.Error, "SELECT docid FROM t1 WHERE content MATCH '\"four five\" NEAR/0 three'")
		}
	}
	{ // do_test "fts3near-1.10"
		r = db.Query("SELECT docid FROM t1 WHERE content MATCH '\"four five\" NEAR/2 one'")
		if r.Error != nil {
			t.Errorf("query error: %v\n  sql: %s", r.Error, "SELECT docid FROM t1 WHERE content MATCH '\"four five\" NEAR/2 one'")
		}
	}
	{ // do_test "fts3near-1.11"
		r = db.Query("SELECT docid FROM t1 WHERE content MATCH '\"four five\" NEAR/1 one'")
		if r.Error != nil {
			t.Errorf("query error: %v\n  sql: %s", r.Error, "SELECT docid FROM t1 WHERE content MATCH '\"four five\" NEAR/1 one'")
		}
	}
	{ // do_test "fts3near-1.12"
		r = db.Query("SELECT docid FROM t1 WHERE content MATCH 'five NEAR/1 \"two three\"'")
		if r.Error != nil {
			t.Errorf("query error: %v\n  sql: %s", r.Error, "SELECT docid FROM t1 WHERE content MATCH 'five NEAR/1 \"two three\"'")
		}
	}
	{ // do_test "fts3near-1.13"
		r = db.Query("SELECT docid FROM t1 WHERE content MATCH 'one NEAR five'")
		if r.Error != nil {
			t.Errorf("query error: %v\n  sql: %s", r.Error, "SELECT docid FROM t1 WHERE content MATCH 'one NEAR five'")
		}
	}
	{ // do_test "fts3near-1.14"
		r = db.Query("SELECT docid FROM t1 WHERE content MATCH 'four NEAR four'")
		if r.Error != nil {
			t.Errorf("query error: %v\n  sql: %s", r.Error, "SELECT docid FROM t1 WHERE content MATCH 'four NEAR four'")
		}
	}
	{ // do_test "fts3near-1.15"
		r = db.Query("SELECT docid FROM t1 WHERE content MATCH 'one NEAR two NEAR one'")
		if r.Error != nil {
			t.Errorf("query error: %v\n  sql: %s", r.Error, "SELECT docid FROM t1 WHERE content MATCH 'one NEAR two NEAR one'")
		}
	}
	...
	{ // do_test "fts3near-3.1"
		r = db.Query("SELECT offsets(t1) FROM t1 WHERE content MATCH 'three NEAR/1 one'")
		if r.Error != nil {
			t.Errorf("query error: %v\n  sql: %s", r.Error, "SELECT offsets(t1) FROM t1 WHERE content MATCH 'three NEAR/1 one'")
		}
	}
	{ // do_test "fts3near-3.2"
		r = db.Query("SELECT offsets(t1) FROM t1 WHERE content MATCH 'one NEAR/1 three'")
		if r.Error != nil {
			t.Errorf("query error: %v\n  sql: %s", r.Error, "SELECT offsets(t1) FROM t1 WHERE content MATCH 'one NEAR/1 three'")
		}
	}
	{ // do_test "fts3near-3.3"
		r = db.Query("SELECT offsets(t1) FROM t1 WHERE content MATCH 'three NEAR/1 two'")
		if r.Error != nil {
			t.Errorf("query error: %v\n  sql: %s", r.Error, "SELECT offsets(t1) FROM t1 WHERE content MATCH 'three NEAR/1 two'")
		}
	}
	{ // do_test "fts3near-3.4"
		r = db.Query("SELECT offsets(t1) FROM t1 WHERE content MATCH 'three NEAR/2 two'")
		if r.Error != nil {
			t.Errorf("query error: %v\n  sql: %s", r.Error, "SELECT offsets(t1) FROM t1 WHERE content MATCH 'three NEAR/2 two'")
		}
	}
	{ // do_test "fts3near-3.5"
		r = db.Query("SELECT offsets(t1) FROM t1 WHERE content MATCH 'two NEAR/2 three'")
		if r.Error != nil {
			t.Errorf("query error: %v\n  sql: %s", r.Error, "SELECT offsets(t1) FROM t1 WHERE content MATCH 'two NEAR/2 three'")
		}
	}
	...
	{ // "fts3near-7.1"
		...
		got := flatten(r)
		want := "{aaa bbb ccc ddd} {bbb ddd aaa ccc}"
		if got != want {
