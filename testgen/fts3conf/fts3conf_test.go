...
func Test_fts3conf(t *testing.T) {
	...
	vtab.TclVarSet("testprefix", "", "fts3conf")
	testprefix = "fts3conf"
	...
	vtab.TclVarSet("T1", "", "INTO t1(rowid, x) VALUES(1, 'x')")
	T1 = "INTO t1(rowid, x) VALUES(1, 'x')"
	_ = T1 // suppress unused warning
	vtab.TclVarSet("T2", "", "INTO t1(rowid, x) SELECT * FROM source")
	T2 = "INTO t1(rowid, x) SELECT * FROM source"
	_ = T2 // suppress unused warning
	vtab.TclVarSet("T3", "", "t1 SET docid = 2 WHERE docid = 1")
	T3 = "t1 SET docid = 2 WHERE docid = 1"
	_ = T3 // suppress unused warning
	vtab.TclVarSet("T4", "", "t1 SET docid = CASE WHEN docid = 1 THEN 4 ELSE 3 END WHERE docid <=2")
	...
	for _idx0 := 0; _idx0+5 <= len(_items0); _idx0 += 5 {
		...
		_ = _idx0
			...
			vtab.TclVarSet("R", "0", "0 {}")
			R_0 = "0 {}"
			_ = R_0 // suppress unused warning
			vtab.TclVarSet("R", "1", "1 {constraint failed}")
