...
func Test_fts3corrupt6(t *testing.T) {
	...
	vtab.TclVarSet("testprefix", "", "fts3corrupt6")
	testprefix = "fts3corrupt6"
	_ = testprefix // suppress unused warning
	vtab.TclVarSet("saved_sqlite_fts3_enable_parentheses", "", sqlite_fts3_enable_parentheses)
	...
	{ // "fts3corrupt6-4.2" — skipped: merge block-id allocation after patched end_block N-A: requires exact fts3NodeWrite absolute block numbering (SQL side effects only)
	...
	vtab.TclVarSet("sqlite_fts3_enable_parentheses", "", saved_sqlite_fts3_enable_parentheses)
