...
func Test_fts3offsets(t *testing.T) {
	...
	vtab.TclVarSet("testprefix", "", "fts3offsets")
	...
	db.RegisterFunction("extract", func(args []interface{}) (interface{}, error) {
		if len(args) < 2 { return "", nil }
		return tclExtractOffsets(tclStr(args[0]), tclStr(args[1])), nil
	}, 2, 2)
	{ // "1.1.0"
