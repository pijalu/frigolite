...
func Test_fts3snippet(t *testing.T) {
	...
	vtab.TclVarSet("testprefix", "", "fts3snippet")
	...
	for _idx0 := 0; _idx0+2 <= len(_items0); _idx0 += 2 {
		...
		_ = _idx0
			...
			// proc definition (not transpiled)
			{ // do_test T + ".8.1"
				vtab.TclVarSet("ten", "", "one two three four five six seven eight nine ten")
			...
			{ // do_test T + ".9.1"
				...
				_ = n // suppress unused warning
					...
					_ = v1 // suppress unused warning
					v2 = strings.Trim(tclStringRepeat(numbers + " ", n), " \t\n\r\v\f")
		...
		{ // do_test "4.2"
			x35 = strings.Trim(tclStringRepeat("x ", "35"), " \t\n\r\v\f")
