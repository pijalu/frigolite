...
func Test_fts4unicode(t *testing.T) {
	...
	// do_unicode_token_test 1.5 The quick brown fox {\n  0 the The 1 quick quick 2 brown brown 3 fox fo...} (unsupported command, not transpiled)
	// do_unicode_token_test 1.6 The\u00bfquick\u224ebrown\u2263fox {\n  0 the The 1 quick quick 2 brown brow... (unsupported command, not transpiled)
	...
	_ = k // suppress unused warning
		mappings = tclListAppend(mappings, strings.ToUpper(k), tclLIndex(map_k, "0"))
		mappings = tclListAppend(mappings, k, tclLIndex(map_k, "1"))
	}
	// proc definition (not transpiled)
	{ // do_test "2.0"
	...
	for _idx0 := 0; _idx0+3 <= len(_items0); _idx0 += 3 {
		...
		// do_unicode_token_test3 5.8 separators=\u0301 hello\u0301world \u0301helloworld 0 helloworld hello\u0301... (unsupported command, not transpiled)
		// do_unicode_token_test3 5.9 tokenchars=\u0301 hello\u0301world \u0301helloworld 0 helloworld hello\u0301... (unsupported command, not transpiled)
		// do_unicode_token_test3 5.10 separators=\u0301 remove_diacritics=0 hello\u0301world \u0301helloworld 0 h... (unsupported command, not transpiled)
