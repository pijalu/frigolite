						...
						for _idx5 := 0; _idx5+3 <= len(_items5); _idx5 += 3 {
							...
							for _idx6 := 0; _idx6+3 <= len(_items6); _idx6 += 3 {
								...
								{ // "5.1.1"
									...
									got := flatten(r)
									want := "t5 ft5 ft5_segments ft5_segdir ft5_docsize ft5_stat"
									if got != want {
										t.Errorf("result mismatch\n  got:  [%s]\n  want: [%s]", got, want)
									}
								}
								...
								{ // "5.1.3"
									...
									got := flatten(r)
									want := "ft6 ft6_segments ft6_segdir ft6_docsize ft6_stat"
									if got != want {
										t.Errorf("result mismatch\n  got:  [%s]\n  want: [%s]", got, want)
									}
								}
								...
								{ // "6.2.3"
									...
									got := flatten(r)
									want := "ft7 ft7_segments ft7_segdir ft7_docsize ft7_stat"
									if got != want {
										t.Errorf("result mismatch\n  got:  [%s]\n  want: [%s]", got, want)
									}
								}
								...
								{ // "fts4content-10.1" — skipped: fs virtual table module (register_fs_module) not implemented (SQL side effects only)
								...
								{ // "fts4content-10.2" — skipped: fs virtual table module (register_fs_module) not implemented (SQL side effects only)
									_res = db.Exec("\n  SELECT path, data FROM vt WHERE rowid = 2;\n")
									_ = _res.Error // tolerate unsupported-feature errors in skipped tests
								}
								{ // "fts4content-10.3" — skipped: fs virtual table module (register_fs_module) not implemented (SQL side effects only)
									_res = db.Exec("\n  CREATE VIRTUAL TABLE ft USING fts4(content=vt);\n  INSERT INTO ft(ft) VALUES('rebuild');\n")
									_ = _res.Error // tolerate unsupported-feature errors in skipped tests
								}
								{ // "fts4content-10.4" — skipped: fs virtual table module (register_fs_module) not implemented (SQL side effects only)
									_res = db.Exec("\n  SELECT snippet(ft, '[', ']', '...', -1, 5) FROM ft WHERE ft MATCH 'e'\n")
									_ = _res.Error // tolerate unsupported-feature errors in skipped tests
								}
								{ // "fts4content-10.5" — skipped: fs virtual table module (register_fs_module) not implemented (SQL side effects only)
									_res = db.Exec("\n  SELECT snippet(ft, '[', ']', '...', -1, 5) FROM ft WHERE ft MATCH 't'\n")
									_ = _res.Error // tolerate unsupported-feature errors in skipped tests
								}
								{ // "fts4content-10.6" — skipped: fs virtual table module (register_fs_module) not implemented (SQL side effects only)
									_res = db.Exec(" DELETE FROM ft WHERE docid=2 ")
									_ = _res.Error // tolerate unsupported-feature errors in skipped tests
								}
								{ // "fts4content-10.7" — skipped: fs virtual table module (register_fs_module) not implemented (SQL side effects only)
									_res = db.Exec("\n  SELECT snippet(ft, '[', ']', '...', -1, 5) FROM ft WHERE ft MATCH 'e'\n")
									_ = _res.Error // tolerate unsupported-feature errors in skipped tests
								}
								db.Close()
