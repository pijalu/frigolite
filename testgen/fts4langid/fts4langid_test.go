...
func Test_fts4langid(t *testing.T) {
	...
	vtab.TclVarSet("testprefix", "", "fts4langid")
	...
	for _, langid := range tclSplitList("0 1 2 " + tclListElem("1073741824")) {
	...
	lid = "1073741824"
	_ = lid // suppress unused warning
	for _, lid := range tclSplitList("4 " + tclListElem("1073741824")) {
	_ = lid // suppress unused warning
		{ // "5.4." + lid + ".1"
