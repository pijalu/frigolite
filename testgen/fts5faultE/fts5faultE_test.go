...
func Test_fts5faultE(t *testing.T) {
	...
	vtab.TclVarSet("testprefix", "", "fts5faultE")
	testprefix = "fts5faultE"
	...
	// do_faultsim_test 1 -prep {\n  faultsim_restore_and_reopen\n} -body {\n  execsql { CREATE VIRTUAL ... (unsupported command, not transpiled)
	db.Close()
	os.Remove("test.db")
	...
	if err != nil { t.Fatal(err) }
	tcl_nullvalue = "{}" // fresh connection resets nullvalue
	// do_faultsim_test 3 -prep {\n  faultsim_restore_and_reopen\n} -body {\n  execsql { \n    SELECT co... (unsupported command, not transpiled)
}
