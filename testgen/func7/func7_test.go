...
func Test_func7(t *testing.T) {
	...
	{ // "func7-pg-301" — skipped: stale %f expectation (SQLite renders 60.000000) (SQL side effects only)
	...
	{ // "func7-pg-311" — skipped: stale %f expectation (SQLite renders 30.000000) (SQL side effects only)
