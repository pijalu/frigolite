...
func Test_hook2(t *testing.T) {
	...
	t.Skipf("TODO: %s not implemented in frigolite", "do_preupdate_test 1.1 {\n  INSERT INTO t1 VALUES('one', 1);\n} {\n  INSERT main t1 0 0  one 1\n}")
	t.Skipf("TODO: %s not implemented in frigolite", "do_preupdate_test 1.2 {\n  UPDATE t1 SET b=2 WHERE a='one';\n} {\n  UPDATE main t1 0 0  one 1 one 2\n}")
	t.Skipf("TODO: %s not implemented in frigolite", "do_preupdate_test 1.3 {\n  DELETE FROM t1 WHERE a='one';\n} {\n  DELETE main t1 0 0  one 2\n}")
	{ // "2.0"
	...
	t.Skipf("TODO: %s not implemented in frigolite", "do_preupdate_test 2.1.1 {\n  INSERT INTO t2(b, c) VALUES(1, 1);\n} {\n  INSERT main t2 0 0  4 1 1\n}")
	{ // "2.1.2.0"
	...
	t.Skipf("TODO: %s not implemented in frigolite", "do_preupdate_test 2.1.2.1 {\n  INSERT INTO t2 SELECT * FROM d1;\n} {\n  INSERT main t2 0 0  1 2 3\n  INSERT main t2 0 0 ...}")
	t.Skipf("TODO: %s not implemented in frigolite", "do_preupdate_test 2.1.2.2 {\n  INSERT INTO t2 SELECT a+20, b+20, c+20 FROM d1;...} {\n  INSERT main t2 0 0  21 22 23\n  INSERT main t2 0...}")
	{ // "2.1.2.3"
	...
	t.Skipf("TODO: %s not implemented in frigolite", "do_preupdate_test 2.1.3 {\n  REPLACE INTO t2 VALUES(45, 22, 23);\n} {\n  DELETE main t2 0 0 21 22 23\n  INSERT main t2 0 ...}")
	t.Skipf("TODO: %s not implemented in frigolite", "do_preupdate_test 2.1.4 {\n  REPLACE INTO t2 VALUES(11, 100, 100);\n} {\n  DELETE main t2 0 0 11 12 13\n  INSERT main t2 0 ...}")
	t.Skipf("TODO: %s not implemented in frigolite", "do_preupdate_test 2.1.5 {\n  REPLACE INTO t2(c, b) VALUES(33, 32)\n} {\n  DELETE main t2 0 0 4 1 1 \n  DELETE main t2 0 0 ...}")
	{ // "2.2.0"
		r = db.Query("\n  SELECT * FROM t2 ORDER BY b,c;\n")
		if r.Error != nil {
			t.Errorf("query error: %v\n  sql: %s", r.Error, "\n  SELECT * FROM t2 ORDER BY b,c;\n")
	...
	t.Skipf("TODO: %s not implemented in frigolite", "do_preupdate_test 2.2.1 {\n  DELETE FROM t2 WHERE b=22;\n} {\n  DELETE main t2 0 0  45 22 23\n}")
	t.Skipf("TODO: %s not implemented in frigolite", "do_preupdate_test 2.2.2 {\n  DELETE FROM t2;\n} {\n  DELETE main t2 0 0 1 2 3 \n  DELETE main t2 0 0 ...}")
	{ // "2.3.0"
	...
	t.Skipf("TODO: %s not implemented in frigolite", "do_preupdate_test 2.3.1 {\n  UPDATE t3 SET x=4 WHERE y IN ('b', 'e', 'x');\n} {\n  UPDATE main t3 0 0  a b c   4 b c\n  UPDATE main...}")
	t.Skipf("TODO: %s not implemented in frigolite", "do_preupdate_test 2.3.2 {\n  UPDATE t3 SET y=y||y WHERE z IN('c', 'f');\n} {\n  UPDATE main t3 0 0  4 b c   4 bb c\n  UPDATE mai...}")
	t.Skipf("TODO: %s not implemented in frigolite", "do_preupdate_test 2.3.3 {\n  UPDATE OR REPLACE t3 SET y='bb' WHERE z='f'\n} {\n  DELETE main t3 0 0  4 bb c\n  UPDATE main t3 0 0...}")
	t.Skipf("TODO: %s not implemented in frigolite", "do_preupdate_test 2.3.4 {\n  UPDATE OR REPLACE t3 SET z=2 WHERE y=1;\n} {\n  DELETE main t3 0 0  2 2 2\n  UPDATE main t3 0 0 ...}")
	t.Skipf("TODO: %s not implemented in frigolite", "do_preupdate_test 2.3.5 {\n  UPDATE OR REPLACE t3 SET z=2, y='bb' WHERE y=3;...} {\n  DELETE main t3 0 0  1 1 2\n  DELETE main t3 0 0 ...}")
}
