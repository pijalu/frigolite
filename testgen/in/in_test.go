...
func Test_in(t *testing.T) {
	...
	{ // do_test "in-1.7"
		...
		got := flatten(r)
		want := "101 102 103 4 5 6 7 8 9 10"
		if got != want && !tclFpnumCompare(got, want) {
			t.Errorf("result mismatch\n  got:  [%s]\n  want: [%s]", got, want)
		}
	}
	...
	{ // do_test "in-3.3"
		...
		got := flatten(r)
		want := "101 102 103 104 5 6 7 8 9 10"
		if got != want && !tclFpnumCompare(got, want) {
			t.Errorf("result mismatch\n  got:  [%s]\n  want: [%s]", got, want)
		}
	}
