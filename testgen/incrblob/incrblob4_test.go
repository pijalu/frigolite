...
func Test_incrblob4(t *testing.T) {
	...
	{ // do_test "2.3"
		...
		_res = db.Exec(" INSERT INTO t1(v) VALUES(" + sqlLiteral(_new) + ") ")
		if _res.Error != nil {
			t.Errorf("exec error: %v\n  sql: %s", _res.Error, " INSERT INTO t1(v) VALUES(" + sqlLiteral(_new) + ") ")
		}
	}
	{ // do_test "3.1"
		db.Close()
	...
	{ // do_test "3.3"
		...
		if _res.Error != nil {
			t.Errorf("exec error: %v\n  sql: %s", _res.Error, " UPDATE t1 SET v = " + sqlLiteral(_new) + " WHERE k = 20 ")
		}
