...
func Test_index(t *testing.T) {
	...
	{ // do_test "index-3.1"
		...
		_ = i // suppress unused warning
		for func() bool { i_n, _i_e := strconv.Atoi(i); if _i_e != nil { return false }; return i_n < 100 }() {
			vtab.TclVarSet("sql", "", "CREATE INDEX " + tclFormat("index%02d", i) + " ON test1(f" + tclExprWith("($i%5)+1", map[string]string{"i": i}) + ")")
	...
	{ // do_test "index-11.1"
		...
		_r_tcl := append([]string{}, tclSplitList(tclExecSQL(db, "SELECT c FROM t3 WHERE b==10"))...)
