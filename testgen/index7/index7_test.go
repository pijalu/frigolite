...
func Test_index7(t *testing.T) {
	...
	{ // "index7-1.1a" — skipped: capture_pragma test helper not transpiled (no 'out' table) (SQL + file side effects only)
	...
	{ // "index7-1.7eqp" — skipped: EXPLAIN QUERY PLAN USING COVERING INDEX not planned (G5.EXPLAIN) (SQL side effects only)
	...
	{ // "index7-8.1" — skipped: EXPLAIN QUERY PLAN USING COVERING INDEX not planned (G5.EXPLAIN) (SQL side effects only)
