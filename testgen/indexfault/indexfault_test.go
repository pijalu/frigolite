...
func Test_indexfault(t *testing.T) {
	...
	vtab.TclVarSet("testprefix", "", "indexfault")
	...
	if err != nil { t.Fatal(err) }
	tcl_nullvalue = "{}" // fresh connection resets nullvalue
	vtab.TclVarSet("custom_filter", "", "xOpen")
	...
	vtab.TclVarSet("custom_filter", "", "xOpen xWrite")
	...
	vtab.TclVarSet("custom_filter", "", "xRead")
