...
func Test_insert(t *testing.T) {
	...
	{ // do_test "insert-5.3"
		...
		// expr [lsearch $x OpenEphemeral]>0 → runtime compare
		_r = tclBool01(toInt(strconv.Itoa(tclLsearch(x, "OpenEphemeral")))  >  0)
	}
	{ // do_test "insert-5.4"
	...
	{ // do_test "insert-5.7"
		...
		_ = x // suppress unused warning
		// expr [lsearch $x OpenTemp]>0 → runtime compare
		_r = tclBool01(toInt(strconv.Itoa(tclLsearch(x, "OpenTemp")))  >  0)
	}
	{ // do_test "insert-6.1"
