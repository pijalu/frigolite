...
func Test_instrfault(t *testing.T) {
	...
	vtab.TclVarSet("testprefix", "", "instrfault")
	testprefix = "instrfault"
	_ = testprefix // suppress unused warning
	vtab.TclVarSet("NEEDLE", "", tclStringRepeat("abcdefghijklmnopqrstuvwxyz", "10"))
	NEEDLE = tclStringRepeat("abcdefghijklmnopqrstuvwxyz", "10") // TCL namespace variable
	_ = NEEDLE // suppress unused warning
	vtab.TclVarSet("HAYSTACK", "", tclStringRepeat("123", "10]" + NEEDLE + tclStringRepeat("456", "10")))
