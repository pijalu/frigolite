...
func Test_join(t *testing.T) {
	...
	t.Skipf("TODO: %s not implemented in frigolite", "jointest join-12.2 30 {0 1}")
	t.Skipf("TODO: %s not implemented in frigolite", "jointest join-12.3 63 {0 1}")
	t.Skipf("TODO: %s not implemented in frigolite", "jointest join-12.4 64 {0 1}")
	t.Skipf("TODO: %s not implemented in frigolite", "jointest join-12.5 65 {1 {at most 64 tables in a join}}")
	t.Skipf("TODO: %s not implemented in frigolite", "jointest join-12.6 66 {1 {at most 64 tables in a join}}")
	t.Skipf("TODO: %s not implemented in frigolite", "jointest join-12.7 127 {1 {at most 64 tables in a join}}")
	t.Skipf("TODO: %s not implemented in frigolite", "jointest join-12.8 128 {1 {at most 64 tables in a join}}")
	{ // "join-13.0"
