...
func Test_misc1(t *testing.T) {
	...
	{ // do_test "misc1-1.1"
		...
		vtab.TclVarSet("cmd", "", "INSERT INTO manycol VALUES(0")
	...
	{ // do_test "misc1-3.1"
		...
		_ = _r // suppress unused warning
		_r = tclLIndex(_r, "1") // lindex result
		if _r != "hi" {
			t.Errorf("result mismatch\n  got:  [%s]\n  want: [%s]\n  body: do_test %s", _r, "hi", "misc1-3.1")
		}
	}
	{ // do_test "misc1-4.1"
	...
	{ // do_test "misc1-10.1"
		vtab.TclVarSet("where", "", "WHERE x0>=0")
	...
	vtab.TclVarSet("fault_callbacks", "", "")
	fault_callbacks = ""
