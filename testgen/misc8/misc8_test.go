...
func Test_misc8(t *testing.T) {
	...
	// db func eval dbeval (db-eval passthrough — built-in eval used)
	{ // "misc8-2.1" — skipped: delete-during-join-iteration requires streaming join (materialized-join gap)
	...
	// dbconfig_maindbname_icecube: main database aliased as icecube
	{ // "misc8-4.2"
