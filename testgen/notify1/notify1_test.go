...
func Test_notify1(t *testing.T) {
	...
	var con string
	_ = con // pre-declared from TCL source
	var lUnlock string
	...
	var conn string
	_ = conn // pre-declared from TCL source
	var unlocked string
	...
	for _idx1 := 0; _idx1+2 <= len(_items1); _idx1 += 2 {
		...
		{ // do_test "notify1-7.4"
			vtab.TclVarSet("unlock_notify", "", "0")
			unlock_notify = "0"
