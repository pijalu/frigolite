...
func Test_permutations(t *testing.T) {
	...
	_ = optionsMap // dynamic-key array from TCL source
	...
	if tclBool(tclBool01(vtab.TclVarExists("env", "QUICKTEST_INCLUDE"))) {
		allquicktests = tclConcat(allquicktests, env_QUICKTEST_INCLUDE)
		_ = allquicktests // suppress unused warning
	}
	if tclBool(tclBool01(vtab.TclVarExists("env", "QUICKTEST_OMIT"))) {
		all = ""
		_ = all // suppress unused warning
		for _, a := range tclSplitList(allquicktests) {
		_ = a // suppress unused warning
			vtab.TclVarSet("bIn", "", "1")
			bIn = "1"
		...
		vtab.TclVarSet("allquicktests", "", all)
		allquicktests = all
		_ = allquicktests // suppress unused warning
	}
	if tclBool(tclBool01(vtab.TclVarExists("env", "TEST_FAILURE"))) {
		vtab.TclVarSet("allquicktests", "", "main.test")
