...
func Test_quota(t *testing.T) {
	...
	{ // do_test "quota-2.1.1"
		_r = tclQuotaSet("*test.db", 4096, "quota_check")
	}
	{ // do_test "quota-2.1.2"
		db, err = frigolite.Open("test.db")
	...
	_ = quota // suppress unused warning
	// proc definition (not transpiled)
	_r = tclQuotaSet("*", 4096, "quota_callback")
	{ // do_test "quota-3.3.1"
		_res = db1a.Exec(" INSERT INTO t1 VALUES(randomblob(500), randomblob(500)) ")
		if _res.Error != nil {
		...
		_ = quota // TCL namespace variable (query)
		got := tclListFlatten(quota)
		want := tclListFlatten("file join [get_pwd] test.db"+" "+"5120")
		if got != want {
	...
	{ // do_test "quota-4.1.2"
		_r = tclQuotaSet("*test.db", 4096, "")
		// quota_list (unsupported command, not transpiled)
	}
	{ // do_test "quota-4.1.3"
		_r = tclQuotaSet("*test2.db", 0, "")
		// quota_list (unsupported command, not transpiled)
	}
	{ // do_test "quota-4.1.4"
		_r = tclQuotaSet("*test2.db", 100000, "")
		// quota_list (unsupported command, not transpiled)
	}
	{ // do_test "quota-4.1.5"
		_r = tclQuotaSet("*test.db", 0, "")
	...
	{ // do_test "quota-4.2.1"
		_r = tclQuotaSet("A", 1000, "")
		_r = tclQuotaSet("B", 1000, "")
		_r = tclQuotaSet("C", 1000, "")
		_r = tclQuotaSet("D", 1000, "")
		// quota_list (unsupported command, not transpiled)
	}
	{ // do_test "quota-4.2.2"
		_r = tclQuotaSet("C", 0, "")
	...
	{ // do_test "quota-4.5.1"
		_r = tclQuotaSet(quotagroup, 100000, "quota_callback")
		// quota_size $::quotagroup (unsupported command, not transpiled)
	}
	{ // do_test "quota-4.5.2"
