...
func Test_returning1(t *testing.T) {
	...
	vtab.TclVarSet("testprefix", "", "returning1")
	...
	{ // do_test "12.2"
		var _cname_arr string
		_ = _cname_arr // suppress unused warning
		_dbevalRows2 := db.Query("INSERT INTO t1(x) VALUES(2) RETURNING [x];")
	...
	{ // do_test "12.3"
		var _cname_arr string
		_ = _cname_arr // suppress unused warning
		_dbevalRows4 := db.Query("INSERT INTO t1(x) VALUES(3) RETURNING x AS [xyz];")
	...
	{ // do_test "12.4"
		var _cname_arr string
		_ = _cname_arr // suppress unused warning
		_dbevalRows6 := db.Query("INSERT INTO t1(x,y) VALUES(4,5) RETURNING \"x\"+\"y\";")
