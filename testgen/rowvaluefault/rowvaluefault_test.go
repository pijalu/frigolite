...
func Test_rowvaluefault(t *testing.T) {
	...
	t.Errorf("TODO: %s not implemented in frigolite", "do_faultsim_test 2 -faults oom* -body {\n  execsql { SELECT fou FROM xyz WHERE (two, thr) ...} -test {\n  faultsim_test_result {0 3} \n}")
	...
	t.Errorf("TODO: %s not implemented in frigolite", "do_faultsim_test 5 -faults oom* -body {\n  execsql { \n    SELECT fou FROM xyz \n    WHERE (...} -test {\n  faultsim_test_result {0 {1 2 3 4}} \n}")
	t.Errorf("TODO: %s not implemented in frigolite", "do_faultsim_test 6 -faults oom* -body {\n  execsql { \n    SELECT fou FROM xyz \n    WHERE (...} -test {\n  faultsim_test_result {0 {2 3}} \n}")
	t.Errorf("TODO: %s not implemented in frigolite", "do_faultsim_test 7 -faults oom* -body {\n  execsql { \n    SELECT fou FROM xyz \n    WHERE (...} -test {\n  faultsim_test_result {0 1}\n}")
