...
func Test_scanstatus(t *testing.T) {
	...
	t.Skipf("TODO: %s not implemented in frigolite", "do_scanstatus_test 1.1b { \n  nLoop 1 nVisit 2 nEst 1048576.0 zName t1 zExpl...}")
	t.Skipf("TODO: %s not implemented in frigolite", "sqlite3_db_config db STMT_SCANSTATUS 0")
	{ // "1.2a"
		r = db.Query(" SELECT count(*) FROM t1, t2; ")
		if r.Error != nil {
			t.Errorf("query error: %v\n  sql: %s", r.Error, " SELECT count(*) FROM t1, t2; ")
	...
	t.Skipf("TODO: %s not implemented in frigolite", "do_scanstatus_test 1.2b { \n}")
	t.Skipf("TODO: %s not implemented in frigolite", "sqlite3_db_config db STMT_SCANSTATUS 1")
	{ // "1.3"
	...
	t.Skipf("TODO: %s not implemented in frigolite", "do_scanstatus_test 1.4 {\n  nLoop 1 nVisit 2 nEst 2.0 zName t1 zExplain {SC...}")
	{ // "1.5"
	...
	t.Skipf("TODO: %s not implemented in frigolite", "do_scanstatus_test 1.7 {\n  nLoop 1 nVisit 2 nEst 2.0 zName t2 zExplain \n  ...}")
	{ // "1.8"
		r = db.Query("\n  SELECT count(*) FROM t1, t2 WHERE t2.rowid>1;\n")
		if r.Error != nil {
			t.Errorf("query error: %v\n  sql: %s", r.Error, "\n  SELECT count(*) FROM t1, t2 WHERE t2.rowid>1;\n")
	...
	t.Skipf("TODO: %s not implemented in frigolite", "do_scanstatus_test 1.9 {\n  nLoop 2 nVisit 4 nEst 2.0 zName t2 zExplain \n  ...}")
	{ // do_test "1.9"
		t.Skipf("TODO: %s not implemented in frigolite", "sqlite3_stmt_scanstatus_reset [db version -last-stmt-ptr]")
	}
	t.Skipf("TODO: %s not implemented in frigolite", "do_scanstatus_test 1.10 {\n  nLoop 0 nVisit 0 nEst 2.0 zName t2 zExplain \n  ...}")
	db.Close()
	db, err = frigolite.Open("")
	...
	t.Skipf("TODO: %s not implemented in frigolite", "do_scanstatus_test 2.2 {\n  nLoop 1 nVisit 1 nEst 1.0 zName x1 \n  zExplain ...}")
	{ // "2.3.1"
	...
	t.Skipf("TODO: %s not implemented in frigolite", "do_scanstatus_test 2.3.2 {\n  nLoop 1 nVisit 1 nEst 10.0 zName x1j \n  zExplai...}")
	{ // "2.4.1"
		r = db.Query("\n  SELECT * FROM x1 WHERE j<'two'\n")
		if r.Error != nil {
			t.Errorf("query error: %v\n  sql: %s", r.Error, "\n  SELECT * FROM x1 WHERE j<'two'\n")
	...
	t.Skipf("TODO: %s not implemented in frigolite", "do_scanstatus_test 2.4.2 {\n  nLoop 1 nVisit 3 nEst 262144.0 zName x1j \n  zEx...}")
	{ // "2.5.1"
		r = db.Query("\n  SELECT * FROM x1 WHERE j>='two'\n")
		if r.Error != nil {
			t.Errorf("query error: %v\n  sql: %s", r.Error, "\n  SELECT * FROM x1 WHERE j>='two'\n")
	...
	t.Skipf("TODO: %s not implemented in frigolite", "do_scanstatus_test 2.5.2 {\n  nLoop 1 nVisit 1 nEst 262144.0 zName x1j \n  zEx...}")
	{ // "2.6.1"
	...
	t.Skipf("TODO: %s not implemented in frigolite", "do_scanstatus_test 2.6.2 {\n  nLoop 1 nVisit 2 nEst 16384.0 zName x1j \n  zExp...}")
	{ // "2.7.1"
	...
	t.Skipf("TODO: %s not implemented in frigolite", "do_scanstatus_test 2.7.2 {\n  nLoop 1 nVisit 2 nEst 16384.0 zName x2j \n  zExp...}")
	{ // "2.8.1"
	...
	t.Skipf("TODO: %s not implemented in frigolite", "do_scanstatus_test 2.8.2 {\n  nLoop 1 nVisit 0 nEst 8.0 zName x2ij \n  zExplai...}")
	{ // "2.9.1"
	...
	t.Skipf("TODO: %s not implemented in frigolite", "do_scanstatus_test 2.9.2 {\n  nLoop 1 nVisit 0 nEst 8.0 zName x2ij \n  zExplai...}")
	{ // "2.10.1"
	...
	t.Skipf("TODO: %s not implemented in frigolite", "do_scanstatus_test 2.10.2 {\n  nLoop 1 nVisit 1 nEst 8.0 zName x2ij \n  zExplai...}")
	{ // "3.1"
	...
	t.Skipf("TODO: %s not implemented in frigolite", "do_scanstatus_test 3.2.2 {\n  nLoop 1 nVisit 1 nEst 10.0 zName a1a \n  zExplai...}")
	{ // "3.2.1"
	...
	t.Skipf("TODO: %s not implemented in frigolite", "do_scanstatus_test 3.4.2 {\n  nLoop 1 nVisit 4 nEst 40.0 zName a1a \n  zExplai...}")
	{ // "3.4.1"
	...
	t.Skipf("TODO: %s not implemented in frigolite", "do_scanstatus_test 4.1.2 {}")
	{ // "4.2"
	...
	t.Skipf("TODO: %s not implemented in frigolite", "do_scanstatus_test 4.2.2 { \n  nLoop 1 nVisit 1 nEst 1.0 zName sqlite_autoind...}")
	db.Close()
	db, err = frigolite.Open("")
	if err != nil { t.Fatal(err) }
	t.Skipf("TODO: %s not implemented in frigolite", "sqlite3_db_config db STMT_SCANSTATUS 1")
	...
	t.Skipf("TODO: %s not implemented in frigolite", "do_scanstatus_test 5.2.2 { \n  nLoop 1 nVisit 2 nEst 2.0 zName sqlite_autoind...}")
	{ // "5.3.1"
	...
	t.Skipf("TODO: %s not implemented in frigolite", "do_scanstatus_test 5.3.3 { \n  nLoop 1 nVisit 19 nEst 56.0 zName t2xy zExplai...}")
	{ // "5.5.1"
	...
	t.Skipf("TODO: %s not implemented in frigolite", "do_scanstatus_test 5.5.3 { \n  nLoop 1 nVisit 501 nEst 480.0 zName t3 zExplai...}")
}
