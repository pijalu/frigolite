...
func Test_select3(t *testing.T) {
	...
	{ // "select3-4.4" — skipped: ORDER BY aggregate over a non-result column with aliased GROUP BY/HAVING: engine collapses groups to one NULL row (SQL + file side effects only)
