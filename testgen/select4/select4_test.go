...
func Test_select4(t *testing.T) {
	...
	{ // "select4-14.3" — skipped: UNION VALUES chain ORDER BY not reproduced N-A (compound SELECT ordering) (SQL side effects only)
		_res = db.Exec("\n  SELECT * FROM t14\n   UNION VALUES(3,2,1),(2,3,1),(1,2,3),(7,8,9),(4,5,6)\n   UNION SELECT * FROM t14 ORDER BY 1, 2, 3\n")
		_ = _res.Error // tolerate unsupported-feature errors in skipped tests
	}
	{ // "select4-14.4" — skipped: UNION VALUES chain ORDER BY not reproduced N-A (compound SELECT ordering) (SQL side effects only)
		_res = db.Exec("\n  SELECT * FROM t14\n   UNION VALUES(3,2,1)\n   UNION SELECT * FROM t14 ORDER BY 1, 2, 3\n")
		_ = _res.Error // tolerate unsupported-feature errors in skipped tests
	}
	{ // "select4-14.5"
