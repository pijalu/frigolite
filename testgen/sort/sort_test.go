...
func Test_sort(t *testing.T) {
	...
	vtab.TclVarSet("testprefix", "", "sort")
	testprefix = "sort"
	...
	for _idx2 := 0; _idx2+7 <= len(_items2); _idx2 += 7 {
		...
		_ = _idx2
			...
			{ // "sort-15." + tn + ".1" — skipped: CTE (WITH) not supported (SQL side effects only)
			...
			{ // "sort-15." + tn + ".3" — skipped: CTE (WITH) not supported (SQL side effects only)
