...
func Test_sortfault(t *testing.T) {
	...
	vtab.TclVarSet("testprefix", "", "sortfault")
	...
	for _idx0 := 0; _idx0+7 <= len(_items0); _idx0 += 7 {
		...
		_ = _idx0
			if tclBool(sqlite_options_threadsafe) {
				vtab.TclVarSet("threadsmode", "", "singlethread")
		...
		// sqlite3_shutdown (unsupported command, not transpiled)
		vtab.TclVarSet("t", "0", "singlethread")
		t_0 = "singlethread"
		_ = t_0 // suppress unused warning
		vtab.TclVarSet("t", "1", "multithread")
		t_1 = "multithread"
		_ = t_1 // suppress unused warning
		vtab.TclVarSet("t", "2", "serialized")
		t_2 = "serialized"
