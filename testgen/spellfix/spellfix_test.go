		...
		for _idx1 := 0; _idx1+3 <= len(_items1); _idx1 += 3 {
			...
			for _idx2 := 0; _idx2+3 <= len(_items2); _idx2 += 3 {
				...
				for _idx3 := 0; _idx3+3 <= len(_items3); _idx3 += 3 {
					...
					// proc definition (not transpiled)
					// do_tracesql_test 6.2.1 {\n    SELECT word FROM t3 WHERE rowid = 10;\n  } {keener\n    {SELECT word, rank, NULL, langid, id F...} (unsupported command, not transpiled)
					// do_tracesql_test 6.2.2 {\n    SELECT word, distance FROM t3 WHERE rowid = ...} {keener {}\n    {SELECT word, rank, NULL, langid, i...} (unsupported command, not transpiled)
					// do_tracesql_test 6.2.3 {\n    SELECT word, distance FROM t3 WHERE rowid = ...} {keener 300\n    {SELECT id, word, rank, coalesce(k...} (unsupported command, not transpiled)
					{ // "7.1"
