...
func Test_stmt(t *testing.T) {
	...
	{ // do_test "stmt-1.2"
		...
		if got != want {
			t.Errorf("result mismatch\n  got:  [%s]\n  want: [%s]\n  body: do_test %s", got, want, "stmt-1.2")
		}
	}
	{ // do_test "stmt-1.3"
		...
		if got != want {
			t.Errorf("result mismatch\n  got:  [%s]\n  want: [%s]\n  body: do_test %s", got, want, "stmt-1.3")
		}
	}
	{ // do_test "stmt-1.4"
		...
		want := tclListFlatten("2")
		if got != want {
			t.Errorf("result mismatch\n  got:  [%s]\n  want: [%s]\n  body: do_test %s", got, want, "stmt-1.4")
		}
	}
	{ // do_test "stmt-1.5"
		_res = db.Exec("COMMIT")
		...
		want := tclListFlatten("1")
		if got != want {
			t.Errorf("result mismatch\n  got:  [%s]\n  want: [%s]\n  body: do_test %s", got, want, "stmt-1.5")
		}
	}
	{ // do_test "stmt-1.6.1"
		...
		want := tclListFlatten("2")
		if got != want {
			t.Errorf("result mismatch\n  got:  [%s]\n  want: [%s]\n  body: do_test %s", got, want, "stmt-1.6.1")
		}
	}
	{ // do_test "stmt-1.6.2"
		...
		want := tclListFlatten("2")
		if got != want {
			t.Errorf("result mismatch\n  got:  [%s]\n  want: [%s]\n  body: do_test %s", got, want, "stmt-1.6.2")
		}
	}
	{ // do_test "stmt-1.7"
		_res = db.Exec("COMMIT")
		...
		want := tclListFlatten("1")
		if got != want {
			t.Errorf("result mismatch\n  got:  [%s]\n  want: [%s]\n  body: do_test %s", got, want, "stmt-1.7")
		}
	}
