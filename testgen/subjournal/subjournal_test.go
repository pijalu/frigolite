...
func Test_subjournal(t *testing.T) {
	...
	vtab.TclVarSet("testprefix", "", "subjournal")
	...
	{ // do_test "2.1"
		...
		_r = tclBackupStep(B, tclExprWith("$nPage-10", map[string]string{"nPage": nPage}))
		if _r != "SQLITE_OK" {
	...
	{ // do_test "2.3"
		_r = tclBackupStep(B, "1000")
		if _r != "SQLITE_DONE" {
			t.Errorf("result mismatch\n  got:  [%s]\n  want: [%s]\n  body: do_test %s", _r, "SQLITE_DONE", "2.3")
		}
	}
	{ // do_test "2.4"
