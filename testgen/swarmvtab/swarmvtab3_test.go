...
func Test_swarmvtab3(t *testing.T) {
	...
	db.RegisterFunction("missing_db", func(args []interface{}) (interface{}, error) { return nil, nil }, 0, -1)
	// proc definition (not transpiled)
	// db function openclose_db (variable-reader, inlined)
	db.RegisterFunction("openclose_db", func(args []interface{}) (interface{}, error) { return nil, nil }, 0, -1)
	// proc definition (not transpiled)
