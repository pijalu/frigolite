...
func Test_sysfault(t *testing.T) {
	...
	// proc definition (not transpiled)
	// do_faultsim_test 1 -faults vfsfault-* -prep {\n  faultsim_restore\n} -body $open_and_write_body -test {\n  faultsim_test_result {0 {wal 1 2 3 4}}       \...} (unsupported command, not transpiled)
	...
	for _idx0 := 0; _idx0+3 <= len(_items0); _idx0 += 3 {
		...
		_ = _idx0
			...
			// do_faultsim_test 1.2.$tn -faults vfsfault-* -prep {\n    faultsim_restore\n  } -body \n    test_syscall errno fstat $errno\n    $open_a... -test \n    faultsim_test_result {0 {wal 1 2 3 4}} $errs... (unsupported command, not transpiled)
		}
		...
		_ = vfs // suppress unused warning
			...
			// faultsim_save_and_close (unsupported command, not transpiled)
			// do_faultsim_test 4 -faults vfsfault-* -prep {\n  faultsim_restore_and_reopen\n  file_control_ch...} -body {\n  test_syscall errno mmap     EACCES\n\n  execsq...} -test {\n  faultsim_test_result {0 {1 2}} {1 {disk I/O er...} (unsupported command, not transpiled)
}
