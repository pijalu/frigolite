...
func Test_temptable(t *testing.T) {
	...
	{ // "temptable-1.2" — skipped: multi-connection visibility not implemented (P7.LOCKING) (no-side-effects)
	}
	...
	{ // "temptable-2.5" — skipped: multi-connection visibility not implemented (P7.LOCKING) (no-side-effects)
	}
	...
	{ // "temptable-6.3" — skipped: readonly filesystem test requires unprivileged user N-A (no-side-effects)
	}
