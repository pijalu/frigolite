...
func Test_timediff1(t *testing.T) {
	...
	t.Skipf("TODO: %s not implemented in frigolite", "datetest 1.1 {datetime('2000-01-31','+1 month')} {2000-03-02 00:00:00}")
	t.Skipf("TODO: %s not implemented in frigolite", "datetest 1.2 {datetime('2004-01-29','+1 month')} {2004-02-29 00:00:00}")
	t.Skipf("TODO: %s not implemented in frigolite", "datetest 1.3 {datetime('2000-03-01','-1 day')} {2000-02-29 00:00:00}")
	t.Skipf("TODO: %s not implemented in frigolite", "datetest 1.4 {datetime('2000-03-31','-1 month')} {2000-03-02 00:00:00}")
	t.Skipf("TODO: %s not implemented in frigolite", "datetest 1.5 {datetime('2000-03-30','-1 month')} {2000-03-01 00:00:00}")
	t.Skipf("TODO: %s not implemented in frigolite", "datetest 1.6 {datetime('2000-03-29','-1 month')} {2000-02-29 00:00:00}")
	t.Skipf("TODO: %s not implemented in frigolite", "datetest 1.7 {datetime('2000-03-28','-1 month')} {2000-02-28 00:00:00}")
	t.Skipf("TODO: %s not implemented in frigolite", "datetest 1.8 {datetime('2000-02-29','+1 year')} {2001-03-01 00:00:00}")
	t.Skipf("TODO: %s not implemented in frigolite", "datetest 1.9 {datetime('2000-02-29','+4 years')} {2004-02-29 00:00:00}")
	t.Skipf("TODO: %s not implemented in frigolite", "datetest 1.10 {datetime('1998-11-10','+0001-03-19 12:34:56')} {2000-02-29 12:34:56}")
	t.Skipf("TODO: %s not implemented in frigolite", "datetest 1.11 {datetime('2000-01-31','+0004-01-00 12:34:56')} {2004-03-02 12:34:56}")
	t.Skipf("TODO: %s not implemented in frigolite", "datetest 1.12 {datetime('2000-01-29','+0008-01-00 12:34:56')} {2008-02-29 12:34:56}")
	t.Skipf("TODO: %s not implemented in frigolite", "datetest 1.13 {datetime('2001-03-31','-0001-01-00 06:10')} {2000-03-01 17:50:00}")
	t.Skipf("TODO: %s not implemented in frigolite", "datetest 2.1 {datetime('2001-01-31','+1 month')} {2001-03-03 00:00:00}")
	t.Skipf("TODO: %s not implemented in frigolite", "datetest 2.2 {datetime('2005-01-29','+1 month')} {2005-03-01 00:00:00}")
	t.Skipf("TODO: %s not implemented in frigolite", "datetest 2.3 {datetime('2001-03-01','-1 day')} {2001-02-28 00:00:00}")
	t.Skipf("TODO: %s not implemented in frigolite", "datetest 2.4 {datetime('2001-03-31','-1 month')} {2001-03-03 00:00:00}")
	t.Skipf("TODO: %s not implemented in frigolite", "datetest 2.5 {datetime('2001-03-30','-1 month')} {2001-03-02 00:00:00}")
	t.Skipf("TODO: %s not implemented in frigolite", "datetest 2.6 {datetime('2001-03-29','-1 month')} {2001-03-01 00:00:00}")
	t.Skipf("TODO: %s not implemented in frigolite", "datetest 2.7 {datetime('2001-03-28','-1 month')} {2001-02-28 00:00:00}")
	t.Skipf("TODO: %s not implemented in frigolite", "datetest 2.10 {datetime('1999-11-10','+0001-03-19 12:34:56')} {2001-03-01 12:34:56}")
	t.Skipf("TODO: %s not implemented in frigolite", "datetest 2.11 {datetime('2000-01-31','+0005-01-00 12:34:56')} {2005-03-03 12:34:56}")
	t.Skipf("TODO: %s not implemented in frigolite", "datetest 2.12 {datetime('2000-01-29','+0009-01-00 12:34:56')} {2009-03-01 12:34:56}")
	t.Skipf("TODO: %s not implemented in frigolite", "datetest 2.13 {datetime('2002-03-31','-0001-01-00 06:10')} {2001-03-02 17:50:00}")
	t.Skipf("TODO: %s not implemented in frigolite", "datetest 3.1 {timediff('2000-03-02','2000-01-31')} {+0000-01-00 00:00:00.000}")
	t.Skipf("TODO: %s not implemented in frigolite", "datetest 3.2 {timediff('2000-01-31','2000-03-02')} {-0000-01-02 00:00:00.000}")
	t.Skipf("TODO: %s not implemented in frigolite", "datetest 3.3 {timediff('2000-03-02','1999-01-31')} {+0001-01-00 00:00:00.000}")
	t.Skipf("TODO: %s not implemented in frigolite", "datetest 3.4 {timediff('1999-01-31','2000-03-02')} {-0001-01-02 00:00:00.000}")
