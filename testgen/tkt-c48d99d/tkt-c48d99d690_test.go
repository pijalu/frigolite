...
func Test_tkt_c48d99d690(t *testing.T) {
	...
	_testprefix := "tkt-c48d99d690" // TCL namespace variable
	{ // do_test "1.0"
	...
	{ // do_test "1.1"
		res = db.Exec(" INSERT INTO t2 SELECT * FROM t1 ")
		if res.Error != nil {
			t.Errorf("exec error: %v\n  sql: %s", res.Error, " INSERT INTO t2 SELECT * FROM t1 ")
		}
	}
	{ // do_test "1.2"
		res = db.Exec("VACUUM")
		if res.Error != nil {
			t.Errorf("exec error: %v\n  sql: %s", res.Error, "VACUUM")
		}
	}
}
