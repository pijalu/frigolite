...
func Test_tkt_f7b4edec(t *testing.T) {
	...
	_enable_shared_cache := "sqlite3_enable_shared_cache 1" // TCL namespace variable
	...
	{ // do_test "tkt-f7b4edec-1"
		res = db.Exec(" CREATE TABLE t1(x, y); ")
		if res.Error != nil {
			t.Errorf("exec error: %v\n  sql: %s", res.Error, " CREATE TABLE t1(x, y); ")
		}
		res = db.Exec(" INSERT INTO t1 VALUES(1, 2) ")
		if res.Error != nil {
			t.Errorf("exec error: %v\n  sql: %s", res.Error, " INSERT INTO t1 VALUES(1, 2) ")
		}
		var _HOOKS string // TCL namespace variable
	}
	HOOKS := ""
