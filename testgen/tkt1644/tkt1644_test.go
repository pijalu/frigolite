...
func Test_tkt1644(t *testing.T) {
	...
	{ // do_test "tkt1644-2.1"
		...
		tclPrepareStep(db, "SELECT * FROM temp_t1", "STMT")
		DUMMY = tclSqlTail("SELECT * FROM temp_t1")
	...
	{ // do_test "tkt1644-2.2"
		...
		tclPrepareStep(db, "SELECT * FROM temp_v1", "STMT")
		DUMMY = tclSqlTail("SELECT * FROM temp_v1")
		_ = DUMMY // suppress unused warning
		_ = STMT // prepared statement handle
		_res = db.Exec("\n      DROP VIEW temp_v1;\n    ")
		if _res.Error != nil {
