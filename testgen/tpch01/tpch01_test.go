...
func Test_tpch01(t *testing.T) {
	...
	var eqpres string
	_ = eqpres // pre-declared from TCL source
	var argv0 string
	_ = argv0 // pre-declared from TCL source

	// set testdir: test directory (not used in Go test context)
	vtab.TclVarSet("testprefix", "", "tpch01")
	testprefix = "tpch01"
