...
func Test_trigger2(t *testing.T) {
	...
	tbl_definitions = "{CREATE TABLE tbl (a, b);}                                         \t{CREATE TABLE tbl (a INTEGER PRIMARY KEY, b);}                           {CREATE TABLE tbl (a, b PRIMARY KEY);}                             \t{CREATE TABLE tbl (a, b); CREATE INDEX tbl_idx ON tbl(b);}"
