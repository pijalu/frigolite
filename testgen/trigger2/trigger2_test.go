...
func Test_trigger2(t *testing.T) {
	...
	vtab.TclVarSet("testprefix", "", "trigger2")
	testprefix = "trigger2"
	...
	_list := tclList([]string{"CREATE TABLE tbl (a, b);", "CREATE TABLE tbl (a INTEGER PRIMARY KEY, b);", "CREATE TABLE tbl (a, b PRIMARY KEY);", "CREATE TABLE tbl (a, b); CREATE INDEX tbl_idx ON tbl(b);", "\\"})
	_ = _list
	_r = _list
	tbl_definitions = _r
