...
func Test_trustschema1(t *testing.T) {
	...
	vtab.TclVarSet("testprefix", "", "trustschema1")
	testprefix = "trustschema1"
	_ = testprefix // suppress unused warning
	// proc definition (not transpiled)
	{ // do_test "1.100"
		db.RegisterFunctionFlags("f1", func(args []interface{}) (interface{}, error) {
	...
	{ // "trustschema1-4.2" — skipped: json_extract() JSON1 extension not implemented (G6 gap) (SQL side effects only)
		_res = db.Exec("\n  PRAGMA trusted_schema=ON;\n  SELECT * FROM test41;\n")
		_ = _res.Error // tolerate unsupported-feature errors in skipped tests
	}
}
