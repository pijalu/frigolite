...
func Test_upfrom2(t *testing.T) {
	...
	vtab.TclVarSet("testprefix", "", "upfrom2")
	testprefix = "upfrom2"
		...
		for _idx1 := 0; _idx1+2 <= len(_items1); _idx1 += 2 {
			...
			for _idx2 := 0; _idx2+2 <= len(_items2); _idx2 += 2 {
				...
				for _idx3 := 0; _idx3+3 <= len(_items3); _idx3 += 3 {
					...
					{ // "upfrom2-7.1" — skipped: UPDATE FROM over a view with COUNT(*) OVER () depends on window-function execution (G4 gap) (SQL side effects only)
