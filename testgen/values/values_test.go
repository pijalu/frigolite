...
func Test_values(t *testing.T) {
	...
	vtab.TclVarSet("testprefix", "", "values")
	testprefix = "values"
	...
	db.SetLimit("SQLITE_LIMIT_COMPOUND_SELECT", toInt(4))
	{ // "1.2.2"
	...
	for _idx0 := 0; _idx0+2 <= len(_items0); _idx0 += 2 {
		...
		_ = _idx0
			db.SetLimit("SQLITE_LIMIT_COMPOUND_SELECT", toInt(iLimit))
			{ // "4.1.1"
		...
		for _idx1 := 0; _idx1+3 <= len(_items1); _idx1 += 3 {
			...
			_ = _idx1
				q1 = strings.ReplaceAll(q, "VVV", VVV)
				_ = q1 // suppress unused warning
				q2 = strings.ReplaceAll(q, "VVV", VVV2)
				_ = q2 // suppress unused warning
				vtab.TclVarSet("q3", "", "WITH VVV AS " + VVV + " " + q)
			...
			{ // "values-13.1" — skipped: zeroblob window-function validation not implemented (G4.WINDOW)
			}
			db.Close()
			os.Remove("test.db")
			os.Remove("test.db-journal")
