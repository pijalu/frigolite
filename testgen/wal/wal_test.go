...
func Test_wal(t *testing.T) {
	...
	{ // do_test "wal-4.4.4"
		var logsize = "file size test.db-wal"
	...
	for _, sector := range []string{"512 4096"} {
	...
	for _, handle := range []string{"db db2 db3"} {
		{
			var _catchErr error
			_ = _catchErr // suppress unused warning
	...
	for _, pgsz := range []string{"512 1024 2048 4096 8192 16384 32768 65536"} {
	...
	for _, mode := range []string{"OFF MEMORY PERSIST DELETE TRUNCATE WAL"} {
