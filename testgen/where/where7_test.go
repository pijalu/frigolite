...
...} (unsupported command, not transpiled)
	...
	{ // do_test "where7-1.4"
		// count_steps {
    SELECT a FROM t1 WHERE +b=3 OR c=6 ORDER BY 1...} (unsupported command, not transpiled)
	}
	{ // do_test "where7-1.5"
		// count_steps {
    SELECT a FROM t1 WHERE 3=b OR c=6 ORDER BY ro...} (unsupported command, not transpiled)
	}
	{ // do_test "where7-1.6"
		// count_steps {
...
...} (unsupported command, not transpiled)
	...
	{ // do_test "where7-1.10"
		// count_steps {
    SELECT a FROM t1 WHERE (b=3 OR c>=10 OR c=4 O...} (unsupported command, not transpiled)
	}
	{ // do_test "where7-1.11"
		// count_steps {
    SELECT a FROM t1 WHERE (d=5 AND b=3) OR c==10...} (unsupported command, not transpiled)
	}
	{ // do_test "where7-1.12"
		// count_steps {
    SELECT a FROM t1 WHERE (b BETWEEN 2 AND 4) OR...} (unsupported command, not transpiled)
	}
	{ // do_test "where7-1.13"
		// count_steps {
    SELECT a FROM t1 WHERE (b BETWEEN 0 AND 2) OR...} (unsupported command, not transpiled)
	}
	{ // do_test "where7-1.14"
		// count_steps {
    SELECT a FROM t1 WHERE (d=8 OR c=6 OR b=4) AN...} (unsupported command, not transpiled)
	}
	{ // do_test "where7-1.15"
		// count_steps {
	...
	{ // do_test "where7-2.3.1"
		// count_steps_sort {
     SELECT a FROM t2
      WHERE (d>=47.0 AND d<...} (unsupported command, not transpiled)
	}
	...
	{ // do_test "where7-2.5.1"
		// count_steps_sort {
     SELECT a FROM t2
      WHERE (f GLOB '?opqr*...} (unsupported command, not transpiled)
	}
	...
	{ // do_test "where7-2.7.1"
		// count_steps_sort {
     SELECT a FROM t2
      WHERE ((a BETWEEN 8 A...} (unsupported command, not transpiled)
	}
	...
	{ // do_test "where7-2.10.1"
		// count_steps_sort {
     SELECT a FROM t2
      WHERE ((a BETWEEN 49 ...} (unsupported command, not transpiled)
	}
	...
	{ // do_test "where7-2.11.1"
		// count_steps_sort {
     SELECT a FROM t2
      WHERE (d>=72.0 AND d<...} (unsupported command, not transpiled)
	}
	...
	{ // do_test "where7-2.12.1"
		// count_steps_sort {
     SELECT a FROM t2
      WHERE (d>=50.0 AND d<...} (unsupported command, not transpiled)
	}
	...
	{ // do_test "where7-2.13.1"
		// count_steps_sort {
     SELECT a FROM t2
      WHERE ((a BETWEEN 50 ...} (unsupported command, not transpiled)
	}
	...
	{ // do_test "where7-2.14.1"
		// count_steps_sort {
     SELECT a FROM t2
      WHERE ((a BETWEEN 47 ...} (unsupported command, not transpiled)
	}
	...
	{ // do_test "where7-2.17.1"
		// count_steps_sort {
     SELECT a FROM t2
      WHERE (d>=68.0 AND d<...} (unsupported command, not transpiled)
	}
	...
	{ // do_test "where7-2.18.1"
		// count_steps_sort {
     SELECT a FROM t2
      WHERE (d>=46.0 AND d<...} (unsupported command, not transpiled)
	}
	...
	{ // do_test "where7-2.19.1"
		// count_steps_sort {
     SELECT a FROM t2
      WHERE (d>=63.0 AND d<...} (unsupported command, not transpiled)
	}
	...
	{ // do_test "where7-2.20.1"
		// count_steps_sort {
     SELECT a FROM t2
      WHERE ((a BETWEEN 27 ...} (unsupported command, not transpiled)
	}
	...
	{ // do_test "where7-2.23.1"
		// count_steps_sort {
     SELECT a FROM t2
      WHERE (g='fedcbaz' AN...} (unsupported command, not transpiled)
	}
	...
	{ // do_test "where7-2.24.1"
		// count_steps_sort {
     SELECT a FROM t2
      WHERE (g='utsrqpo' AN...} (unsupported command, not transpiled)
	}
	...
	{ // do_test "where7-2.26.1"
		// count_steps_sort {
     SELECT a FROM t2
      WHERE (d>=30.0 AND d<...} (unsupported command, not transpiled)
	}
 ...
 ...} (unsupported command, not transpiled)
	...
	{ // do_test "where7-2.33.1"
		// count_steps_sort {
     SELECT a FROM t2
      WHERE (f GLOB '?stuv*...} (unsupported command, not transpiled)
	}
	...
	{ // do_test "where7-2.36.1"
		// count_steps_sort {
     SELECT a FROM t2
      WHERE (d>=6.0 AND d<7...} (unsupported command, not transpiled)
	}
	...
	{ // do_test "where7-2.39.1"
		// count_steps_sort {
     SELECT a FROM t2
      WHERE (g='kjihgfe' AN...} (unsupported command, not transpiled)
	}
	...
	{ // do_test "where7-2.41.1"
		// count_steps_sort {
     SELECT a FROM t2
      WHERE (d>=73.0 AND d<...} (unsupported command, not transpiled)
	}
	...
	{ // do_test "where7-2.42.1"
		// count_steps_sort {
     SELECT a FROM t2
      WHERE (f GLOB '?efgh*...} (unsupported command, not transpiled)
	}
	...
	{ // do_test "where7-2.43.1"
		// count_steps_sort {
     SELECT a FROM t2
      WHERE (d>=78.0 AND d<...} (unsupported command, not transpiled)
	}
	...
	{ // do_test "where7-2.44.1"
		// count_steps_sort {
     SELECT a FROM t2
      WHERE (d>=42.0 AND d<...} (unsupported command, not transpiled)
	}
	...
	{ // do_test "where7-2.46.1"
		// count_steps_sort {
     SELECT a FROM t2
      WHERE (g='ihgfedc' AN...} (unsupported command, not transpiled)
	}
	...
	{ // do_test "where7-2.48.1"
		// count_steps_sort {
     SELECT a FROM t2
      WHERE (d>=12.0 AND d<...} (unsupported command, not transpiled)
	}
	...
	{ // do_test "where7-2.49.1"
		// count_steps_sort {
     SELECT a FROM t2
      WHERE (g='wvutsrq' AN...} (unsupported command, not transpiled)
	}
	...
	{ // do_test "where7-2.54.1"
		// count_steps_sort {
     SELECT a FROM t2
      WHERE ((a BETWEEN 68 ...} (unsupported command, not transpiled)
	}
	...
	{ // do_test "where7-2.55.1"
		// count_steps_sort {
     SELECT a FROM t2
      WHERE ((a BETWEEN 76 ...} (unsupported command, not transpiled)
	}
 ...
 ...} (unsupported command, not transpiled)
	...
	{ // do_test "where7-2.61.1"
		// count_steps_sort {
     SELECT a FROM t2
      WHERE (d>=9.0 AND d<1...} (unsupported command, not transpiled)
	}
	...
	{ // do_test "where7-2.64.1"
		// count_steps_sort {
     SELECT a FROM t2
      WHERE (d>=93.0 AND d<...} (unsupported command, not transpiled)
	}
	...
	{ // do_test "where7-2.68.1"
		// count_steps_sort {
     SELECT a FROM t2
      WHERE (g='gfedcba' AN...} (unsupported command, not transpiled)
	}
	...
	{ // do_test "where7-2.73.1"
		// count_steps_sort {
     SELECT a FROM t2
      WHERE (d>=11.0 AND d<...} (unsupported command, not transpiled)
	}
	...
	{ // do_test "where7-2.78.1"
		// count_steps_sort {
     SELECT a FROM t2
      WHERE (d>=85.0 AND d<...} (unsupported command, not transpiled)
	}
	...
	{ // do_test "where7-2.80.1"
		// count_steps_sort {
     SELECT a FROM t2
      WHERE (g='jihgfed' AN...} (unsupported command, not transpiled)
	}
 ...
 ...} (unsupported command, not transpiled)
	...
	{ // do_test "where7-2.85.1"
		// count_steps_sort {
     SELECT a FROM t2
      WHERE (g='lkjihgf' AN...} (unsupported command, not transpiled)
	}
	...
	{ // do_test "where7-2.86.1"
		// count_steps_sort {
     SELECT a FROM t2
      WHERE ((a BETWEEN 71 ...} (unsupported command, not transpiled)
	}
	...
	{ // do_test "where7-2.87.1"
		// count_steps_sort {
     SELECT a FROM t2
      WHERE ((a BETWEEN 14 ...} (unsupported command, not transpiled)
	}
	...
	{ // do_test "where7-2.89.1"
		// count_steps_sort {
     SELECT a FROM t2
      WHERE ((a BETWEEN 65 ...} (unsupported command, not transpiled)
	}
 ...
 ...} (unsupported command, not transpiled)
	...
	{ // do_test "where7-2.101.1"
		// count_steps_sort {
     SELECT a FROM t2
      WHERE ((a BETWEEN 98 ...} (unsupported command, not transpiled)
	}
	...
	{ // do_test "where7-2.103.1"
		// count_steps_sort {
     SELECT a FROM t2
      WHERE ((a BETWEEN 91 ...} (unsupported command, not transpiled)
	}
 ...
 ...} (unsupported command, not transpiled)
	...
	{ // do_test "where7-2.105.1"
		// count_steps_sort {
     SELECT a FROM t2
      WHERE (g='xwvutsr' AN...} (unsupported command, not transpiled)
	}
	...
	{ // do_test "where7-2.114.1"
		// count_steps_sort {
     SELECT a FROM t2
      WHERE (g='vutsrqp' AN...} (unsupported command, not transpiled)
	}
	...
	{ // do_test "where7-2.116.1"
		// count_steps_sort {
     SELECT a FROM t2
      WHERE ((a BETWEEN 12 ...} (unsupported command, not transpiled)
	}
	...
	{ // do_test "where7-2.118.1"
		// count_steps_sort {
     SELECT a FROM t2
      WHERE ((a BETWEEN 74 ...} (unsupported command, not transpiled)
	}
	...
	{ // do_test "where7-2.119.1"
		// count_steps_sort {
     SELECT a FROM t2
      WHERE (d>=3.0 AND d<4...} (unsupported command, not transpiled)
	}
	...
	{ // do_test "where7-2.121.1"
		// count_steps_sort {
     SELECT a FROM t2
      WHERE (f GLOB '?uvwx*...} (unsupported command, not transpiled)
	}
	...
	{ // do_test "where7-2.126.1"
		// count_steps_sort {
     SELECT a FROM t2
      WHERE (d>=87.0 AND d<...} (unsupported command, not transpiled)
	}
	...
	{ // do_test "where7-2.127.1"
		// count_steps_sort {
     SELECT a FROM t2
      WHERE ((a BETWEEN 62 ...} (unsupported command, not transpiled)
	}
	...
	{ // do_test "where7-2.129.1"
		// count_steps_sort {
     SELECT a FROM t2
      WHERE (d>=26.0 AND d<...} (unsupported command, not transpiled)
	}
	...
	{ // do_test "where7-2.130.1"
		// count_steps_sort {
     SELECT a FROM t2
      WHERE (d>=71.0 AND d<...} (unsupported command, not transpiled)
	}
	...
	{ // do_test "where7-2.134.1"
		// count_steps_sort {
     SELECT a FROM t2
      WHERE (d>=80.0 AND d<...} (unsupported command, not transpiled)
	}
	...
	{ // do_test "where7-2.135.1"
		// count_steps_sort {
     SELECT a FROM t2
      WHERE ((a BETWEEN 84 ...} (unsupported command, not transpiled)
	}
	...
	{ // do_test "where7-2.138.1"
		// count_steps_sort {
     SELECT a FROM t2
      WHERE (f GLOB '?cdef*...} (unsupported command, not transpiled)
	}
	...
	{ // do_test "where7-2.141.1"
		// count_steps_sort {
     SELECT a FROM t2
      WHERE (f GLOB '?qrst*...} (unsupported command, not transpiled)
	}
	...
	{ // do_test "where7-2.149.1"
		// count_steps_sort {
     SELECT a FROM t2
      WHERE (d>=44.0 AND d<...} (unsupported command, not transpiled)
	}
	...
	{ // do_test "where7-2.154.1"
		// count_steps_sort {
     SELECT a FROM t2
      WHERE (f GLOB '?rstu*...} (unsupported command, not transpiled)
	}
 ...
 ...} (unsupported command, not transpiled)
	...
	{ // do_test "where7-2.159.1"
		// count_steps_sort {
     SELECT a FROM t2
      WHERE (d>=66.0 AND d<...} (unsupported command, not transpiled)
	}
 ...
 ...} (unsupported command, not transpiled)
	...
	{ // do_test "where7-2.165.1"
		// count_steps_sort {
     SELECT a FROM t2
      WHERE (g='hgfedcb' AN...} (unsupported command, not transpiled)
	}
	...
	{ // do_test "where7-2.168.1"
		// count_steps_sort {
     SELECT a FROM t2
      WHERE (d>=23.0 AND d<...} (unsupported command, not transpiled)
	}
	...
	{ // do_test "where7-2.169.1"
		// count_steps_sort {
     SELECT a FROM t2
      WHERE ((a BETWEEN 59 ...} (unsupported command, not transpiled)
	}
	...
	{ // do_test "where7-2.174.1"
		// count_steps_sort {
     SELECT a FROM t2
      WHERE (g='qponmlk' AN...} (unsupported command, not transpiled)
	}
	...
	{ // do_test "where7-2.175.1"
		// count_steps_sort {
     SELECT a FROM t2
      WHERE ((a BETWEEN 20 ...} (unsupported command, not transpiled)
	}
	...
	{ // do_test "where7-2.178.1"
		// count_steps_sort {
     SELECT a FROM t2
      WHERE ((a BETWEEN 15 ...} (unsupported command, not transpiled)
	}
	...
	{ // do_test "where7-2.180.1"
		// count_steps_sort {
     SELECT a FROM t2
      WHERE (g='nmlkjih' AN...} (unsupported command, not transpiled)
	}
	...
	{ // do_test "where7-2.182.1"
		// count_steps_sort {
     SELECT a FROM t2
      WHERE (g='ponmlkj' AN...} (unsupported command, not transpiled)
	}
	...
	{ // do_test "where7-2.183.1"
		// count_steps_sort {
     SELECT a FROM t2
      WHERE (g='tsrqpon' AN...} (unsupported command, not transpiled)
	}
	...
	{ // do_test "where7-2.187.1"
		// count_steps_sort {
     SELECT a FROM t2
      WHERE ((a BETWEEN 66 ...} (unsupported command, not transpiled)
	}
	...
	{ // do_test "where7-2.193.1"
		// count_steps_sort {
     SELECT a FROM t2
      WHERE (f GLOB '?jklm*...} (unsupported command, not transpiled)
	}
	...
	{ // do_test "where7-2.196.1"
		// count_steps_sort {
     SELECT a FROM t2
      WHERE ((a BETWEEN 83 ...} (unsupported command, not transpiled)
	}
 ...
 ...} (unsupported command, not transpiled)
	...
	{ // do_test "where7-2