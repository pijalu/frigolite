...
func Test_where7(t *testing.T) {
	...
	{ // do_test "where7-1.20"
		vtab.TclVarSet("sql", "", "SELECT a FROM t1 WHERE a=11 OR b=11")
	...
	{ // do_test "where7-1.21"
		vtab.TclVarSet("sql", "", "SELECT a FROM t1 WHERE b=11 OR c=11")
	...
	{ // do_test "where7-1.31"
		vtab.TclVarSet("sql", "", "SELECT a FROM t1 WHERE (a=11 AND b=11)")
	...
	{ // do_test "where7-1.32"
		vtab.TclVarSet("sql", "", "SELECT a FROM t1 WHERE (b=11 AND c=11)")
