...
func Test_whereD(t *testing.T) {
	...
	t.Skipf("TODO: %s not implemented in frigolite", "do_searchcount_test 3.1 {\n  SELECT a, b FROM t3 WHERE (a=1 AND b='one') OR ...} {1 one 2 two search 4}")
	t.Skipf("TODO: %s not implemented in frigolite", "do_searchcount_test 3.2 {\n  SELECT a, c FROM t3 WHERE (a=1 AND b='one') OR ...} {1 i 2 ii search 6}")
	t.Skipf("TODO: %s not implemented in frigolite", "do_searchcount_test 3.4.1 {\n  SELECT y FROM t4 WHERE x='a'\n} {one search 2}")
	t.Skipf("TODO: %s not implemented in frigolite", "do_searchcount_test 3.4.2 {\n  SELECT a, b FROM t3 WHERE \n        (a=1 AND b=(...} {1 one 2 two search 6}")
	t.Skipf("TODO: %s not implemented in frigolite", "do_searchcount_test 3.4.3 {\n  SELECT a, b FROM t3 WHERE \n        (a=2 AND b='...} {2 two 1 one search 6}")
	t.Skipf("TODO: %s not implemented in frigolite", "do_searchcount_test 3.4.4 {\n  SELECT a, b FROM t3 WHERE \n        (a=2 AND b=(...} {2 two 1 one search 8}")
	t.Skipf("TODO: %s not implemented in frigolite", "do_searchcount_test 3.5.1 {\n  SELECT a, b FROM t3 WHERE (a=1 AND b='one') OR ...} {1 one 2 two search 2}")
	t.Skipf("TODO: %s not implemented in frigolite", "do_searchcount_test 3.5.2 {\n  SELECT a, c FROM t3 WHERE (a=1 AND b='one') OR ...} {1 i 2 ii search 3}")
	{ // do_test "4.1"
	...
	t.Skipf("TODO: %s not implemented in frigolite", "do_searchcount_test 6.2.1 {\n  SELECT e FROM x1 WHERE b=2 OR c=7;\n} {A B search 6}")
	t.Skipf("TODO: %s not implemented in frigolite", "do_searchcount_test 6.2.2 {\n  SELECT c FROM x1 WHERE b=2 OR c=7;\n} {3 7 search 4}")
	t.Skipf("TODO: %s not implemented in frigolite", "do_searchcount_test 6.3.1 {\n  SELECT e FROM x1 WHERE a=1 OR b=10;\n} {A C search 6}")
	t.Skipf("TODO: %s not implemented in frigolite", "do_searchcount_test 6.3.2 {\n  SELECT c FROM x1 WHERE a=1 OR b=10;\n} {3 11 search 5}")
	t.Skipf("TODO: %s not implemented in frigolite", "do_searchcount_test 6.3.3 {\n  SELECT rowid FROM x1 WHERE a=1 OR b=10;\n} {1 3 search 4}")
	t.Skipf("TODO: %s not implemented in frigolite", "do_searchcount_test 6.4.1 {\n  SELECT a FROM x1 WHERE b BETWEEN 1 AND 4 OR c B...} {1 9 search 6}")
	t.Skipf("TODO: %s not implemented in frigolite", "do_searchcount_test 6.4.2 {\n  SELECT b, c FROM x1 WHERE b BETWEEN 1 AND 4 OR ...} {2 3 10 11 search 5}")
	t.Skipf("TODO: %s not implemented in frigolite", "do_searchcount_test 6.4.3 {\n  SELECT rowid, c FROM x1 WHERE b BETWEEN 1 AND 4...} {1 3 3 11 search 4}")
	t.Skipf("TODO: %s not implemented in frigolite", "do_searchcount_test 6.5.1 {\n  SELECT a FROM x1 WHERE rowid = 2 OR c=11\n} {5 9 search 3}")
	t.Skipf("TODO: %s not implemented in frigolite", "do_searchcount_test 6.5.2 {\n  SELECT d FROM x1 WHERE rowid = 2 OR c=11\n} {8 12 search 2}")
	t.Skipf("TODO: %s not implemented in frigolite", "do_searchcount_test 6.5.3 {\n  SELECT d FROM x1 WHERE c=11 OR rowid = 2\n} {12 8 search 2}")
	t.Skipf("TODO: %s not implemented in frigolite", "do_searchcount_test 6.5.4 {\n  SELECT a FROM x1 WHERE c=11 OR rowid = 2 \n} {9 5 search 3}")
	t.Skipf("TODO: %s not implemented in frigolite", "do_searchcount_test 6.6.1 {\n  SELECT rowid FROM x1 WHERE a=1 OR b=6 OR c=11\n} {1 2 3 search 6}")
	t.Skipf("TODO: %s not implemented in frigolite", "do_searchcount_test 6.6.2 {\n  SELECT c FROM x1 WHERE a=1 OR b=6 OR c=11\n} {3 7 11 search 7}")
	t.Skipf("TODO: %s not implemented in frigolite", "do_searchcount_test 6.6.3 {\n  SELECT c FROM x1 WHERE c=11 OR a=1 OR b=6 \n} {11 3 7 search 7}")
	t.Skipf("TODO: %s not implemented in frigolite", "do_searchcount_test 6.6.4 {\n  SELECT c FROM x1 WHERE b=6 OR c=11 OR a=1\n} {7 11 3 search 7}")
	{ // "6.7"
