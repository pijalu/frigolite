...
func Test_with1(t *testing.T) {
	...
	vtab.TclVarSet("testprefix", "", "with1")
	...
	{ // "with1-10.2" — skipped: depends on TCL insert_into_tree proc (tree population) not transpilable (SQL side effects only)
	...
	// proc definition (not transpiled)
	// insert_into_tree {\n  /a/b\n  /a/b/c\n  /a/d\n  /a/d/e\n  /a/d/f\n  ...} (unsupported command, not transpiled)
	{ // "with1-10.3" — skipped: depends on TCL scan_tree proc (tree traversal) not transpilable
	}
	{ // "with1-10.4" — skipped: depends on TCL scan_tree proc (tree traversal) not transpilable
	}
	{ // "with1-10.5" — skipped: depends on TCL scan_tree proc (tree traversal) not transpilable
	}
	{ // "with1-10.6" — skipped: depends on TCL scan_tree proc (tree traversal) not transpilable
	}
	{ // "10.7.1"
	...
	// insert_into_tree {\n  /a/b\n  /a/C\n  /a/d\n  /B/e\n  /B/F\n  /B/g\n...} (unsupported command, not transpiled)
	{ // "with1-10.8.1" — skipped: depends on TCL insert_into_tree proc (tree population) not transpilable (SQL side effects only)
	...
	{ // "with1-10.8.2" — skipped: depends on TCL insert_into_tree proc (tree population) not transpilable (SQL side effects only)
	...
	{ // "with1-10.8.3" — skipped: depends on TCL insert_into_tree proc (tree population) not transpilable (SQL side effects only)
	...
	{ // do_test "17.2"
		...
		_A_arr = vtab.TclVarGet("A", "*")
		got := tclListFlatten(_A_arr)
		want := tclListFlatten("b")
		if got != want {
			t.Errorf("result mismatch\n  got:  [%s]\n  want: [%s]\n  body: do_test %s", got, want, "17.2")
		}
	}
	{ // "17.3"
	...
	{ // "with1-22.1" — skipped: NOT MATERIALIZED CTE inlining (SQLITE_MAX_SRCLIST expansion) is a planner optimization not implemented
	}
