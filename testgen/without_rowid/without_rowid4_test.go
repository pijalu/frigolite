...
func Test_without_rowid4(t *testing.T) {
	...
	tbl_definitions = tclListAppend(tbl_definitions, "CREATE TEMP TABLE tbl (a PRIMARY KEY, b) WITHOUT rowid")
	tbl_definitions = tclListAppend(tbl_definitions, "CREATE TEMPORARY TABLE tbl (a INTEGER PRIMARY KEY, b) WITHOUT rowid;")
	...
	{ // do_test "without_rowid4-3.2"
		...
		if flatten(r) != t232 {
			t.Errorf("result mismatch\n  got:  [%s]\n  want: [%s]\n  body: do_test %s", flatten(r), t232, "without_rowid4-3.2")
		}
	}
	_res = db.Exec("\n  DROP TABLE tbl;\n  DROP TABLE log;\n")
	if _res.Error != nil {
