...
func Test_without_rowid3(t *testing.T) {
	...
	_ = msg // suppress unused warning
						{ // catch block
							...
							_ = fd
							fd = "incrblob_1"
							incrblob_1, _berr = db.OpenBlob("main", "t2", "b", tclRowID(1), true)
							if _berr != nil {
								_catchErr = _berr
								incrblob_1 = nil
								_r = ""
					...
					for _idx5 := 0; _idx5+2 <= len(_items5); _idx5 += 2 {
						...
						for _idx6 := 0; _idx6+2 <= len(_items6); _idx6 += 2 {
							...
							nTotal = strconv.FormatInt(db.TotalChanges(), 10)
								...
								for _idx8 := 0; _idx8+2 <= len(_items8); _idx8 += 2 {
									...
									{ // do_test "without_rowid3-genfkey.1.9"
										...
										if _res.Error == nil || !strings.Contains(_res.Error.Error(), "NOT NULL constraint failed: t1.a") {
											t.Errorf("expected error containing %q, got: %v\n  sql: %s", "NOT NULL constraint failed: t1.a", resErrString(_res), " UPDATE t1 SET a = NULL ")
										}
									}
