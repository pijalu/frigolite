Frigolite testgen status  (generated 2026-09-16T22:43:11Z)
...
CRUD                   59     48     11      0   81.4%
CTE-WINDOW             34     30      4      0   88.2%
EXPR                   43     37      4      2   86.0%
FTS                   240    154     33     53   64.2%
FUNCTIONS              25     20      5      0   80.0%
JOIN                   37     26      4      7   70.3%
JSON                   12      9      2      1   75.0%
ORDER                  26     21      4      1   80.8%
OTHER                 507    351     44    112   69.2%
PLANNER                38     19      0     19   50.0%
RTREE                  27     19      1      7   70.4%
SCHEMA                121    101     15      5   83.5%
SESSION                 2      2      0      0  100.0%
VTAB                   49     38      4      7   77.6%
WAL                    49     11      2     36   22.4%
----------------------------------------------------------
TOTAL                1363    940    136    287   69.0%
...
delete_pkg         CRUD           fail      1 files — 60s)
...
select1            CRUD           fail      1 files — 6]
          want: [a.f1 11 a.f2 22 b.x 5 b.y 6]
        ...
...
selectD            CRUD           fail      1 files — --- FAIL: Test_selectD (0.00s)
    selectD_test.go:145: q...
...
windowfault        CTE-WINDOW     fail      1 files — --- FAIL: Test_windowfault (1.78s)
    windowfault_test.g...
...
without_rowid3     CTE-WINDOW     fail      1 files, 13 tests skipped — --- FAIL: Test_without_rowid3 (0.13s)
    without_rowid3_...
without_rowid4     CTE-WINDOW     fail      1 files, 3 tests skipped — --- FAIL: Test_without_rowid4 (0.17s)
    without_rowid4_...
...
whereL             EXPR           fail      1 files — ID           int,
            RunYearMonth int
          ...
...
wherelimit2        EXPR           fail      1 files, 6 tests skipped — --- FAIL: Test_wherelimit2 (0.09s)
    wherelimit2_test.g...
...
fts3b              FTS            fail      1 files — olite/frigolite_vacuum.go:68 +0x14c
...
fts3defer          FTS            fail      1 files — e.go:804 +0x390
github.com/pijalu/frigolite.(*DB).Query(0...
...
fts4check          FTS            fail      1 files — , 0x3a83a9458720, {0x101428197?, 0x4?}, {0x10142b60b?, 0x...
...
fts4merge          FTS            fail      1 files — , 0x53ba683db440, {0x10072a51c?, 0xf?}, {0x0?, 0x1007296f...
fts4merge2         FTS            pass      1 files
fts4merge3         FTS            pass      1 files
fts4merge4         FTS            fail      1 files — 390
github.com/pijalu/frigolite.(*DB).Exec(0x150044e420c0...
...
fts4upfrom         FTS            fail      1 files — _test.go:167: result mismatch
          got:  [1 a {} apr...
...
fts5aj             FTS            fail      1 files — c/engine_core.go:804 +0x390
...
fts5bigid          FTS            fail      1 files — e.go:804 +0x390
github.com/pijalu/frigolite.(*DB).Exec(0x...
fts5bigpl          FTS            fail      1 files — 0x518
github.com/pijalu/frigolite.(*DB).Exec(0x1a51f56906...
...
fts5contentless    FTS            fail      1 files — --- FAIL: Test_fts5contentless (0.01s)
    fts5contentles...
fts5contentless2   FTS            fail      1 files — lite.(*DB).Exec(0x56e7bfd2a660, {0x56e7c1cb0780, 0x48})
	...
fts5contentless3   FTS            fail      1 files — [3]
          want: [200]
    fts5contentless3_test.go:27...
fts5contentless4   FTS            fail      1 files — --- FAIL: Test_fts5contentless4 (0.09s)
    fts5contentle...
...
fts5delete         FTS            fail      1 files — :804 +0x390
github.com/pijalu/frigolite.(*DB).Exec(0xa943...
...
fts5hash           FTS            fail      1 files — --- FAIL: Test_fts5hash (0.33s)
...
fts5merge          FTS            fail      1 files — .go:804 +0x390
github.com/pijalu/frigolite.(*DB).Exec(0x3...
fts5merge2         FTS            pass      1 files
fts5misc           FTS            fail      1 files — --- FAIL: Test_fts5misc (7.67s)
    fts5misc_test.go:472:...
fts5multi          FTS            pass      1 files
fts5multiclient    FTS            pass      1 files
fts5near           FTS            pass      1 files
fts5onepass        FTS            pass      1 files
fts5optimize       FTS            fail      1 files — github.com/pijalu/frigolite.(*DB).Exec(0x355dc0f24a20, {0...
...
github.com/pijalu/frigolite.(*DB).Query(0x305697b25e...
...
func_pkg           FUNCTIONS      fail      1 files, 50 tests skipped — Inf Inf]
          want: [Inf Inf Inf]
    func_test.go:2...
...
join               JOIN           fail      1 files, 7 tests skipped — ER", got: unknown join type: OUTER NATURAL
          sql:...
...
join8              JOIN           fail      1 files, 8 tests skipped — --- FAIL: Test_join8 (0.10s)
    join8_test.go:529: query...
...
json102            JSON           fail      1 files — ull {} null]
    json102_test.go:2435: result mismatch
  ...
...
orderby1           ORDER          fail      1 files, 21 tests skipped — --- FAIL: Test_orderby1 (0.72s)
...
closure01          OTHER          fail      1 files, 3 tests skipped — --- FAIL: Test_closure01 (10.05s)
    closure01_test.go:9...
...
corruptC           OTHER          fail      1 files — ib/dev/frigolite/internal/pager/pager.go:331
github.com/p...
corruptD           OTHER          pass      1 files
corruptE           OTHER          pass      1 files
corruptF           OTHER          fail      1 files — --- FAIL: Test_corruptF (0.37s)
    corruptF_test.go:95: ...
...
e_fkey             OTHER          fail      1 files — p7\"", got: <nil>
          sql: UPDATE p7 SET a = ?, b =...
...
e_totalchanges     OTHER          fail      1 files — --- FAIL: Test_e_totalchanges (0.05s)
    e_totalchanges_...
...
misc1              OTHER          fail      1 files, 1 tests skipped — go:667: expected success, got error: table t10 already ex...
misc2              OTHER          pass      1 files
misc3              OTHER          fail      1 files — --- FAIL: Test_misc3 (0.06s)
...
speed1p            OTHER          fail      1 files — tgen/speed1p.tclListAppend({0x2ddc11c0c000, 0xaf6b6}, {0x...
...
tkt1443            OTHER          fail      1 files — = 'limited'
                   and Users.userId = UserGro...
...
tkt3493            OTHER          fail      1 files — T OUTER JOIN A_B ON B.id = A_B.B_id  
            LEFT OU...
tkt3508            OTHER          pass      1 files
tkt3522            OTHER          pass      1 files
tkt3527            OTHER          fail      1 files — m.ElemId AS ElemId,
              InnerElem.ElemCode,
   ...
...
tkt_d11f09d36e     OTHER          fail      1 files — /pijalu/frigolite.(*DB).Exec(0x20dbc392a660, {0x1027dac94...
...
rtreeH             RTREE          fail      1 files — ec/engine_core.go:804 +0x390
github.com/pijalu/frigolite....
...
altercol           SCHEMA         fail      1 files, 2 tests skipped — --- FAIL: Test_altercol (0.06s)
    altercol_test.go:1117...
...
altermalloc3       SCHEMA         fail      1 files — ec error: no such column: four
          sql: 
          ...
alterqf            SCHEMA         fail      1 files, 1 tests skipped — --- FAIL: Test_alterqf (0.00s)
    alterqf_test.go:114: e...
...
attach4            SCHEMA         fail      1 files — --- FAIL: Test_attach4 (0.02s)
    attach4_test.go:165: r...
attachmalloc       SCHEMA         pass      1 files
autoinc            SCHEMA         fail      1 files — --- FAIL: Test_autoinc (0.06s)
...
fkey8              SCHEMA         fail      1 files — --- FAIL: Test_fkey8 (0.02s)
    fkey8_test.go:330: resul...
...
indexexpr1         SCHEMA         fail      1 files, 40 tests skipped — --- FAIL: Test_indexexpr1 (0.02s)
    indexexpr1_test.go:...
...
trans2             SCHEMA         fail      1 files — engine_core.go:804 +0x390
...
triggerD           SCHEMA         fail      1 files — --- FAIL: Test_triggerD (0.01s)
    triggerD_test.go:73: ...
...
intarray           VTAB           fail      1 files — _core.go:804 +0x390
...
vtabH              VTAB           fail      1 files — xec/engine_core.go:804 +0x390
github.com/pijalu/frigolite...
...
vtab_shared        VTAB           fail      1 files, 26 tests skipped — --- FAIL: Test_vtab_shared (0.00s)
    vtab_shared_test.g...
...
zipfile            VTAB           fail      1 files — --- FAIL: Test_zipfile (0.07s)
    zipfile_test.go:929: r...
