Frigolite testgen status  (generated 2026-09-09T19:27:02Z)
...
aggorderby         AGG            fail      1 files, 6 tests skipped — --- FAIL: Test_aggorderby (1.92s)
    aggorderby_test.go:...
count              AGG            fail      1 files — --- FAIL: Test_count (2.58s)
...
upsert4            CRUD           fail      1 files — --- FAIL: Test_upsert4 (0.02s)
...
with1              CTE-WINDOW     fail      1 files, 9 tests skipped — --- FAIL: Test_with1 (3.53s)
...
fts3comp1          FTS            fail      1 files — smatch
          got:  [{}]
          want: [eight 1 1 fo...
fts3conf           FTS            fail      1 files — --- FAIL: Test_fts3conf (0.04s)
...
fts3defer          FTS            fail      1 files — --- FAIL: Test_fts3defer (73.27s)
    fts3defer_test.go:2...
...
fts4merge4         FTS            fail      1 files — bc jbd jbe jbf jbg jbh jbi jbj jca jcb jcc jcd jce jcf jc...
...
avtrans            OTHER          fail      1 files — --- FAIL: Test_avtrans (170.19s)
    avtrans_test.go:495:...
...
rtree2             RTREE          fail      1 files — [1]
          body: do_test rtree2-rtree.1.5.990.1
    rt...
rtree3             RTREE          fail      1 files — UE constraint failed: rt_node.nodeno
          sql:  INSE...
...
github.com/pijalu/frigolite.(*DB).Exec(0x648c5d...
...
trans              SCHEMA         fail      1 files — --- FAIL: Test_trans (4.95s)
...
transitive1        SCHEMA         fail      1 files — --- FAIL: Test_transitive1 (0.04s)
    transitive1_test.g...
...
intarray           VTAB           fail      1 files — --- FAIL: Test_intarray (57.37s)
