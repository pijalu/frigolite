...
var skipTestFiles = map[string]string{
	...
	"analyze":       "deep-engine applicable gap DEFERRED (tracked for later phase)",
	"analyze3":      "deep-engine applicable gap DEFERRED (tracked for later phase)",
	"analyze4":      "deep-engine applicable gap DEFERRED (tracked for later phase)",
	"analyze5":      "deep-engine applicable gap DEFERRED (tracked for later phase)",
	"analyze6":      "deep-engine applicable gap DEFERRED (tracked for later phase)",
	"analyze7":      "deep-engine applicable gap DEFERRED (tracked for later phase)",
	"analyze8":      "deep-engine applicable gap DEFERRED (tracked for later phase)",
	"analyze9":      "deep-engine applicable gap DEFERRED (tracked for later phase)",
	"analyzeE":      "deep-engine applicable gap DEFERRED (tracked for later phase)",
	...
	"snapshot3":       "multi-connection/locking not implemented DEFERRED",
	"snapshot4":       "multi-connection/locking not implemented DEFERRED",
	"snapshot_fault":  "VFS/fault-injection harness N-A",
	"snapshot_up":     "multi-connection/locking not implemented DEFERRED",
	...
	"wal9":          "WAL journal mode not implemented N-A",
